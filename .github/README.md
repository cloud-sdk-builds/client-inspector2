...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.292.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.292.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mdGZ5RaPIV9VV9SouCzQ5ePlsLDEDreLwtNSGu42QWnGy8bsjy8crBH3Hn4NhHw/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.292.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.292.0/index.min.mjs": "sha384-mdGZ5RaPIV9VV9SouCzQ5ePlsLDEDreLwtNSGu42QWnGy8bsjy8crBH3Hn4NhHw/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.292.0/LICENSE
```

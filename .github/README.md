...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.186.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.186.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/ZgMvZ5wjXGLypOmxVqNr3utnckr5xglnJNLGR5buFkt+96J0wweRKwsboimiHlh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.186.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.186.0/index.min.mjs": "sha384-/ZgMvZ5wjXGLypOmxVqNr3utnckr5xglnJNLGR5buFkt+96J0wweRKwsboimiHlh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.186.0/LICENSE
```

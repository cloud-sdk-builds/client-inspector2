...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.926.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.926.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1/YbMHoM5fgXIpy+RIBpjWyACjPWKsJ30ws0ThF4hA814zVoTSqCHTC/TfBuKC2Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.926.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.926.0/index.min.mjs": "sha384-1/YbMHoM5fgXIpy+RIBpjWyACjPWKsJ30ws0ThF4hA814zVoTSqCHTC/TfBuKC2Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.926.0/LICENSE
```

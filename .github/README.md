...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.48.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.48.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SsJd86RAJNkOFVEXH04EFZDOKfx31G/L7Ao4cHVRVzHXwUS1PWhkvojV8dahLgGn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.48.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.48.0/index.min.mjs": "sha384-SsJd86RAJNkOFVEXH04EFZDOKfx31G/L7Ao4cHVRVzHXwUS1PWhkvojV8dahLgGn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.48.0/LICENSE
```

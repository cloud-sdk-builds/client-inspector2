...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.131.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.131.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jvAMjO7nTlu3R63NmDGnsKK4UDmNbKTS8cLIbxbkdQMcDUl6EbOv/UsyhRFYnLgS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.131.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.131.0/index.min.mjs": "sha384-jvAMjO7nTlu3R63NmDGnsKK4UDmNbKTS8cLIbxbkdQMcDUl6EbOv/UsyhRFYnLgS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.131.0/LICENSE
```

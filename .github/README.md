...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.975.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.975.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UrMO7yhabWtay0f1NuOGWdRXQ3f+z+oojcH6ufuOrY3K+jixUMVErwS0HRLjKtYe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.975.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.975.0/index.min.mjs": "sha384-UrMO7yhabWtay0f1NuOGWdRXQ3f+z+oojcH6ufuOrY3K+jixUMVErwS0HRLjKtYe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.975.0/LICENSE
```

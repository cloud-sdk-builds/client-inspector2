...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.665.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.665.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lWDZtvxU+fJccMACiEkAlenVaK/NbqN0BKtxzsgr+fYNA09foDDe9MWk26aPywje
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.665.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.665.0/index.min.mjs": "sha384-lWDZtvxU+fJccMACiEkAlenVaK/NbqN0BKtxzsgr+fYNA09foDDe9MWk26aPywje"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.665.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.766.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.766.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Bxlr5HkHlOwGednvlU94WkcQ27E17fyjVtInxcBzGof4Y2OFh7TJJj4z5Y4onRWl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.766.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.766.0/index.min.mjs": "sha384-Bxlr5HkHlOwGednvlU94WkcQ27E17fyjVtInxcBzGof4Y2OFh7TJJj4z5Y4onRWl"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.766.0`)
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.766.0/LICENSE
```

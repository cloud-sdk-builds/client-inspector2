...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.342.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.342.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/JwXL0mlSozvNVZk6LMZnZP6/zK1WQu2WpxriT9q/+ogCP/SQ4uLsUcd4InVOpoG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.342.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.342.0/index.min.mjs": "sha384-/JwXL0mlSozvNVZk6LMZnZP6/zK1WQu2WpxriT9q/+ogCP/SQ4uLsUcd4InVOpoG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.342.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.179.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.179.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4hQUoM8i4LNMRcB2qPtFlFdYKXgRqga4u5/JC1jLZ7RKgQsUOH1yUfGBTJsahvSx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.179.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.179.0/index.min.mjs": "sha384-4hQUoM8i4LNMRcB2qPtFlFdYKXgRqga4u5/JC1jLZ7RKgQsUOH1yUfGBTJsahvSx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.179.0/LICENSE
```

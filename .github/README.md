...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.300.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.300.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zY1O4ajsLFrT7lLynpIhbMXzDi2vmR9tfWw2gcGAjO4mH4bOksKqy9Pe71FsGXTN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.300.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.300.0/index.min.mjs": "sha384-zY1O4ajsLFrT7lLynpIhbMXzDi2vmR9tfWw2gcGAjO4mH4bOksKqy9Pe71FsGXTN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.300.0/LICENSE
```

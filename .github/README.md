...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.294.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.294.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-34Z+lAFDpAu4R6HDGbEMU3cT2fgcwnhk19jQslOrhOI+vGnc3+640P/yDE4nTjhc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.294.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.294.0/index.min.mjs": "sha384-34Z+lAFDpAu4R6HDGbEMU3cT2fgcwnhk19jQslOrhOI+vGnc3+640P/yDE4nTjhc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.294.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.691.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.691.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9cekc7VOTgT1UlbQRy8+6z7yjkfW5kPs54I/xYqZ+CmzG/kq9DCNwxuc/wAVBHrt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.691.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.691.0/index.min.mjs": "sha384-9cekc7VOTgT1UlbQRy8+6z7yjkfW5kPs54I/xYqZ+CmzG/kq9DCNwxuc/wAVBHrt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.691.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.166.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.166.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L1DLwRfeo+IWtaIE+Id0/cEn8zpuWuf2XZKGaa8bYRYXuViGhENUAqgH0SgnCq7g
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.166.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.166.0/index.min.mjs": "sha384-L1DLwRfeo+IWtaIE+Id0/cEn8zpuWuf2XZKGaa8bYRYXuViGhENUAqgH0SgnCq7g"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.166.0`)
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.166.0/LICENSE
```

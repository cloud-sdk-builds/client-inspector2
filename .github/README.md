...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.81.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.81.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/7b4WXU58lP7kYjE8KIct17MfHUJjgQOJl1+esVdwCtr1PXcC7p+aeFWOG8fEu3y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.81.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.81.0/index.min.mjs": "sha384-/7b4WXU58lP7kYjE8KIct17MfHUJjgQOJl1+esVdwCtr1PXcC7p+aeFWOG8fEu3y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.81.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.276.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.276.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IBZrb215WCij4w3zGuUcEn2dnW4zML0GEs9xantdBiPNiadOfpGaj9Ax28kgEecV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.276.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.276.0/index.min.mjs": "sha384-IBZrb215WCij4w3zGuUcEn2dnW4zML0GEs9xantdBiPNiadOfpGaj9Ax28kgEecV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.276.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.430.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.430.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+5sfwtIE7GMTaTi9A/XMOASqR09XSmrbGDfJf1nSMGusIM1PHmzHms7unGfMY1GG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.430.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.430.0/index.min.mjs": "sha384-+5sfwtIE7GMTaTi9A/XMOASqR09XSmrbGDfJf1nSMGusIM1PHmzHms7unGfMY1GG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.430.0/LICENSE
```

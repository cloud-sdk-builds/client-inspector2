...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.658.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.658.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ohmxwmB6lcY2dOKyvaZbWspZQZgEwdBIDzt/w4L4uwZA06a980NzoQavfdHvCm6Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.658.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.658.0/index.min.mjs": "sha384-ohmxwmB6lcY2dOKyvaZbWspZQZgEwdBIDzt/w4L4uwZA06a980NzoQavfdHvCm6Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.658.0/LICENSE
```

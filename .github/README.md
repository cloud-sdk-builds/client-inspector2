...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.999.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.999.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6R9xoqsyDuuK2XKo1ApFv5b1TXb+gxKdEzh761zJNtO8VD+gyxndhvM00a3XXH4U
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.999.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.999.0/index.min.mjs": "sha384-6R9xoqsyDuuK2XKo1ApFv5b1TXb+gxKdEzh761zJNtO8VD+gyxndhvM00a3XXH4U"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.999.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.575.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.575.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gTahCYKdzD6s0H0YIBTR2cF9G8+by3w26AkJhSBxvgeDreTXCMTABmaTIHfflH3W
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.575.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.575.0/index.min.mjs": "sha384-gTahCYKdzD6s0H0YIBTR2cF9G8+by3w26AkJhSBxvgeDreTXCMTABmaTIHfflH3W"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.575.0/LICENSE
```

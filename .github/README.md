...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.299.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.299.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u/3Np+7nf3qdVZFBkB5EkcI1wHyiDejoZPjPQIx26NDA4fnP+oOn14nxIwmw2uck
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.299.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.299.0/index.min.mjs": "sha384-u/3Np+7nf3qdVZFBkB5EkcI1wHyiDejoZPjPQIx26NDA4fnP+oOn14nxIwmw2uck"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.299.0/LICENSE
```

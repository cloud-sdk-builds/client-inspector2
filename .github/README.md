...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.943.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.943.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MCPDUI4KjH9Ajt378TVV5kW+EmPo0rA1N+IXZBi3BT0aE+HwX/TvgGBtkC1MLsku
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.943.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.943.0/index.min.mjs": "sha384-MCPDUI4KjH9Ajt378TVV5kW+EmPo0rA1N+IXZBi3BT0aE+HwX/TvgGBtkC1MLsku"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.943.0/LICENSE
```

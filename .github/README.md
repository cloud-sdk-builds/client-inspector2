...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.468.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.468.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Sia3WsdtQUJMM3cCig0XjjFYkFKL3tb9R1svLdesOyoxD9OxYSY9pcwQW/HNJC1x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.468.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.468.0/index.min.mjs": "sha384-Sia3WsdtQUJMM3cCig0XjjFYkFKL3tb9R1svLdesOyoxD9OxYSY9pcwQW/HNJC1x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.468.0/LICENSE
```

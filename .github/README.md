...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.844.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.844.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-o+8zNIFPV6zwZI/W+Z0tYuE1e3KNB1PTVRw5gVEskcjw/VWy2PfNoYz8qvNH+Ixn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.844.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.844.0/index.min.mjs": "sha384-o+8zNIFPV6zwZI/W+Z0tYuE1e3KNB1PTVRw5gVEskcjw/VWy2PfNoYz8qvNH+Ixn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.844.0/LICENSE
```

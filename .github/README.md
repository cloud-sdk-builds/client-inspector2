...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.989.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.989.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-chQWLl1jOt0Z0KC+50R6fS0NcXyg0s/pRG5fjIsva2SV9RIfXNwi/qQAVDF3puB/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.989.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.989.0/index.min.mjs": "sha384-chQWLl1jOt0Z0KC+50R6fS0NcXyg0s/pRG5fjIsva2SV9RIfXNwi/qQAVDF3puB/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.989.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.858.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.858.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Oz6So6figo9r8O4Kjn1iUy6vErQiwv45YmKwoMAUS4rPWaffPUGfHCftIMxu5XrO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.858.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.858.0/index.min.mjs": "sha384-Oz6So6figo9r8O4Kjn1iUy6vErQiwv45YmKwoMAUS4rPWaffPUGfHCftIMxu5XrO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.858.0/LICENSE
```

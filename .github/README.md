...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.991.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.991.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dCpflDxgvamk1DtJeqOStnXphMCiKJfwnav4ySLcvjx0jWmUK7wpxG36mPEo6STS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.991.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.991.0/index.min.mjs": "sha384-dCpflDxgvamk1DtJeqOStnXphMCiKJfwnav4ySLcvjx0jWmUK7wpxG36mPEo6STS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.991.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.450.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.450.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dWvScjO0dtPinfcwpgR9KmdyHiK8ufajvahp/26JBP+d3xAPn2EYkqIHWlJ/AmRr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.450.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.450.0/index.min.mjs": "sha384-dWvScjO0dtPinfcwpgR9KmdyHiK8ufajvahp/26JBP+d3xAPn2EYkqIHWlJ/AmRr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.450.0/LICENSE
```

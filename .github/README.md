...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.289.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.289.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DXqBGC6QbzyBzZUlz/VcWfL5LcD4kujE3is+pv0gK34Kfyd0USOG5wAOpSpIVPOl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.289.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.289.0/index.min.mjs": "sha384-DXqBGC6QbzyBzZUlz/VcWfL5LcD4kujE3is+pv0gK34Kfyd0USOG5wAOpSpIVPOl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.289.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.572.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.572.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-J9HmYXUTLMzORlyqEeTrvOwXLL3C7JC0Qxih7rsb0I0EtrpdC+diIiKQNLGMs/G6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.572.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.572.0/index.min.mjs": "sha384-J9HmYXUTLMzORlyqEeTrvOwXLL3C7JC0Qxih7rsb0I0EtrpdC+diIiKQNLGMs/G6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.572.0/LICENSE
```

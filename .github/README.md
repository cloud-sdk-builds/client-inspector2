...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.197.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.197.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-X4yR9nwUULIw7b8AVTiDkuFTwkql3BSdyekD/NRNIF0WWZUEc5F3gxTWTi9T0UH0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.197.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.197.0/index.min.mjs": "sha384-X4yR9nwUULIw7b8AVTiDkuFTwkql3BSdyekD/NRNIF0WWZUEc5F3gxTWTi9T0UH0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.197.0/LICENSE
```

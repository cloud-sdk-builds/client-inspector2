...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.782.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.782.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-guKHAKvfmmz3Ck0M3LWXomkboztFLX8tLI16Ujw0Dl9/xwF7HyUe9y3NB/T7BvPc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.782.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.782.0/index.min.mjs": "sha384-guKHAKvfmmz3Ck0M3LWXomkboztFLX8tLI16Ujw0Dl9/xwF7HyUe9y3NB/T7BvPc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.782.0/LICENSE
```

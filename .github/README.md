...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.298.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.298.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+l+tIVH6Z6S5dWKqqeKpXH9GPfyJWFrI4mb65/P4ZR3+qoXGZDY0z0o+1U2ldkMe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.298.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.298.0/index.min.mjs": "sha384-+l+tIVH6Z6S5dWKqqeKpXH9GPfyJWFrI4mb65/P4ZR3+qoXGZDY0z0o+1U2ldkMe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.298.0/LICENSE
```

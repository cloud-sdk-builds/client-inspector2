...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.686.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.686.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0GyrfUudCa5QRxmrb3oZ10Kb5v0Vh8ocsve6t9YGwC4qCI6U8tecauhzj1f6s/d7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.686.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.686.0/index.min.mjs": "sha384-0GyrfUudCa5QRxmrb3oZ10Kb5v0Vh8ocsve6t9YGwC4qCI6U8tecauhzj1f6s/d7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.686.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.413.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.413.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2+r481igazt5CUratQ3uf8WTxiWu9YApAfVQr/KHB2pmRmvirdv4mPECPL9lRDG6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.413.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.413.0/index.min.mjs": "sha384-2+r481igazt5CUratQ3uf8WTxiWu9YApAfVQr/KHB2pmRmvirdv4mPECPL9lRDG6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.413.0/LICENSE
```

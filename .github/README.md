...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.414.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.414.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wtwGFcwB2SRDqh4SVONu0zmurXroGUF+EcTW11q5Z8qK+kgD2gnW1XqMwBY9WTft
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.414.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.414.0/index.min.mjs": "sha384-wtwGFcwB2SRDqh4SVONu0zmurXroGUF+EcTW11q5Z8qK+kgD2gnW1XqMwBY9WTft"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.414.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.669.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.669.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CAuKwXJ59DGahQc1E1eiODQ4CltDoIFyUKsUE/Us8lZv06tANT0faXIxahSg+vUw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.669.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.669.0/index.min.mjs": "sha384-CAuKwXJ59DGahQc1E1eiODQ4CltDoIFyUKsUE/Us8lZv06tANT0faXIxahSg+vUw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.669.0/LICENSE
```

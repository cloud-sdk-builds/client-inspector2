...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.525.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.525.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DIAaOw+3EGlVZSKMxD/a3q3p+Djsre7g3VO6xhDzPlqNJ6HOqHWuAMEQmEnM0MsR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.525.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.525.0/index.min.mjs": "sha384-DIAaOw+3EGlVZSKMxD/a3q3p+Djsre7g3VO6xhDzPlqNJ6HOqHWuAMEQmEnM0MsR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.525.0/LICENSE
```

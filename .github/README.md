...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.674.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.674.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d6nnL8FGSV2fhGgIWZVeFmd38biRBxdE+8SQnugju0BeVite/dn8uJ5ma/wcUikf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.674.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.674.0/index.min.mjs": "sha384-d6nnL8FGSV2fhGgIWZVeFmd38biRBxdE+8SQnugju0BeVite/dn8uJ5ma/wcUikf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.674.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.574.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.574.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+7lPjJdZuGZkRZbmYqWUvk997HAfN4Bw76acfBTbVUbA9Hz7FBKGO9cCkP0+JSN8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.574.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.574.0/index.min.mjs": "sha384-+7lPjJdZuGZkRZbmYqWUvk997HAfN4Bw76acfBTbVUbA9Hz7FBKGO9cCkP0+JSN8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.574.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.917.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.917.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eeLgLP04GJHqQRl0C45aiFQXR2jCfygYdnGKbDGmkMw7t6BWWi4fxIeLTslxVHC7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.917.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.917.0/index.min.mjs": "sha384-eeLgLP04GJHqQRl0C45aiFQXR2jCfygYdnGKbDGmkMw7t6BWWi4fxIeLTslxVHC7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.917.0/LICENSE
```

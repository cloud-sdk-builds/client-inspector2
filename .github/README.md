...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.287.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.287.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HSclhxou5Fy0qKum6CI2oJBWtET09ToUD+tvzgtcfhMVH9+kpDrEg034WxiWJRtm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.287.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.287.0/index.min.mjs": "sha384-HSclhxou5Fy0qKum6CI2oJBWtET09ToUD+tvzgtcfhMVH9+kpDrEg034WxiWJRtm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.287.0/LICENSE
```

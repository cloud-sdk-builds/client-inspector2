...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.687.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.687.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ih8oyj7yPKQZydUGXjK5818Sy+6IIuf16grTFCvo4U3UbmPl1p3aGSqQTcaLhB3m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.687.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.687.0/index.min.mjs": "sha384-ih8oyj7yPKQZydUGXjK5818Sy+6IIuf16grTFCvo4U3UbmPl1p3aGSqQTcaLhB3m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.687.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.309.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.309.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HYJJkv+rQ+EntITCNsgExptEOsGKIWoNdmls5H4piIH51Y/c5JqEoAiHRgV2/9SH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.309.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.309.0/index.min.mjs": "sha384-HYJJkv+rQ+EntITCNsgExptEOsGKIWoNdmls5H4piIH51Y/c5JqEoAiHRgV2/9SH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.309.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.387.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.387.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xM/1G3s6C0qMBKtMo/uZ7cEF3+zYZeiG6CHTLBVeiJk4HfdujU17sfmv36JjNc0m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.387.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.387.0/index.min.mjs": "sha384-xM/1G3s6C0qMBKtMo/uZ7cEF3+zYZeiG6CHTLBVeiJk4HfdujU17sfmv36JjNc0m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.387.0/LICENSE
```

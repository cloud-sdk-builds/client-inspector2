...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.828.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.828.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oJYR6IuoGQczUDtyLY94gjRPeNinmU9Vz509UDMISN6s/ANC+Bk60aYO9ozHA6yE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.828.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.828.0/index.min.mjs": "sha384-oJYR6IuoGQczUDtyLY94gjRPeNinmU9Vz509UDMISN6s/ANC+Bk60aYO9ozHA6yE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.828.0/LICENSE
```

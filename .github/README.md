...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.202.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.202.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YDTFA2yw4PXRd+mdZt2cRaX0K6LnqCzhYFwPIw03K0lHai/SNi/GdJOfF7Z1Eczs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.202.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.202.0/index.min.mjs": "sha384-YDTFA2yw4PXRd+mdZt2cRaX0K6LnqCzhYFwPIw03K0lHai/SNi/GdJOfF7Z1Eczs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.202.0/LICENSE
```

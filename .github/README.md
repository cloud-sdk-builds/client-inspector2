...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.816.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.816.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/AsHprusixOz9YC+FlJk/tu4/ybB/0+uFJpN6PjnJwj7ljMIFxutRVt53P795yU5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.816.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.816.0/index.min.mjs": "sha384-/AsHprusixOz9YC+FlJk/tu4/ybB/0+uFJpN6PjnJwj7ljMIFxutRVt53P795yU5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.816.0/LICENSE
```

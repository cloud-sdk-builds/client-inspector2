...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.352.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.352.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q/hYot5UqGDhiRBavy6nOukYa7C248Js3U5+jjWfo+tdGTx3ub2CTbic7fWk/Nkl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.352.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.352.0/index.min.mjs": "sha384-q/hYot5UqGDhiRBavy6nOukYa7C248Js3U5+jjWfo+tdGTx3ub2CTbic7fWk/Nkl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.352.0/LICENSE
```

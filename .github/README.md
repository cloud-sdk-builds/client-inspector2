...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.328.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.328.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ohd1CjiaBdwMKD+Oi1OaszwYcP4hE2fpJN9fyE5ZM5StQmef7jRxf98+uYFuguqR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.328.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.328.0/index.min.mjs": "sha384-Ohd1CjiaBdwMKD+Oi1OaszwYcP4hE2fpJN9fyE5ZM5StQmef7jRxf98+uYFuguqR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.328.0/LICENSE
```

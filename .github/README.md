...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.699.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.699.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K72Aovz7FTshwRnB0ZdZ6nylZcO0uBvCq8zuLe0V1ToK/iPqhk0UPMjF1lvmwHjP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.699.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.699.0/index.min.mjs": "sha384-K72Aovz7FTshwRnB0ZdZ6nylZcO0uBvCq8zuLe0V1ToK/iPqhk0UPMjF1lvmwHjP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.699.0/LICENSE
```

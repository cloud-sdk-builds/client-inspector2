...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.821.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.821.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M7qTCvnBR4T06N6LrM2Qfwd5zckAMiDInTWGGor/Cq8MJnXjtTGCwZsSpEYpOUgr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.821.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.821.0/index.min.mjs": "sha384-M7qTCvnBR4T06N6LrM2Qfwd5zckAMiDInTWGGor/Cq8MJnXjtTGCwZsSpEYpOUgr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.821.0/LICENSE
```

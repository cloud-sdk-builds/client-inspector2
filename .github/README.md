...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.212.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.212.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k5OrPhz6rIK5RhKMvQW8iLQqjIO3M3bkNQkwLwHLvUFiX9LDqTX1xRFFHVlRDU9u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.212.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.212.0/index.min.mjs": "sha384-k5OrPhz6rIK5RhKMvQW8iLQqjIO3M3bkNQkwLwHLvUFiX9LDqTX1xRFFHVlRDU9u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.212.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.997.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.997.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3dTxMgekG0/JxfTQ0s94KcKvNduI1+eDzB6swPTmPGgHyH+GnCz2t9ysRXez/Zul
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.997.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.997.0/index.min.mjs": "sha384-3dTxMgekG0/JxfTQ0s94KcKvNduI1+eDzB6swPTmPGgHyH+GnCz2t9ysRXez/Zul"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.997.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.58.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.58.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V1z2wVSlHmP4WMaONtn+8lF7LZBbSJ8x5d/yE+I3ZWg+Z6G/nSHkyWjAtcZTGNh8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.58.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.58.0/index.min.mjs": "sha384-V1z2wVSlHmP4WMaONtn+8lF7LZBbSJ8x5d/yE+I3ZWg+Z6G/nSHkyWjAtcZTGNh8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.58.0/LICENSE
```

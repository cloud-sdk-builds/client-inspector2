...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.229.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.229.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vd3X1jOE+ayKEI/aOreMBos9IO3GShuFud7U7Zn/gZ+GA6erc20+rKGjl70JAp+O
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.229.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.229.0/index.min.mjs": "sha384-vd3X1jOE+ayKEI/aOreMBos9IO3GShuFud7U7Zn/gZ+GA6erc20+rKGjl70JAp+O"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.229.0/LICENSE
```

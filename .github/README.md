...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.503.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.503.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ya94T7a2KnX8IE1Zs7dGMbK+AZAFMdIkLNTb1CbFG4oGL3sKVlULRIXshhk3cTpJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.503.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.503.1/index.min.mjs": "sha384-Ya94T7a2KnX8IE1Zs7dGMbK+AZAFMdIkLNTb1CbFG4oGL3sKVlULRIXshhk3cTpJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.503.1/LICENSE
```

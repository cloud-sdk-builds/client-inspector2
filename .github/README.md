...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.477.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.477.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LFWIlVpcb6CriG1kd9bB7amP3rrmWNVGTbzdbER7e0ZKICG9S+IIub6DE6AqpWDK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.477.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.477.0/index.min.mjs": "sha384-LFWIlVpcb6CriG1kd9bB7amP3rrmWNVGTbzdbER7e0ZKICG9S+IIub6DE6AqpWDK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.477.0/LICENSE
```

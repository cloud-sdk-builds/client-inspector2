...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.337.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.337.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K5khZ41jIdnCQ10IXH7EVVxBnUEeeRY4gZ6wIO5ulo7eP8Rb5zDOrYs3iNCg6+nj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.337.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.337.0/index.min.mjs": "sha384-K5khZ41jIdnCQ10IXH7EVVxBnUEeeRY4gZ6wIO5ulo7eP8Rb5zDOrYs3iNCg6+nj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.337.0/LICENSE
```

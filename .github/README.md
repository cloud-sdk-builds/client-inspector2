...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.1018.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1018.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DbpceXe+nL9tVYPk1HJRh+IIs4i2MIb6abSHXlE0YLEKQY3y1y2PTSUt2RVRIOo9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1018.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1018.0/index.min.mjs": "sha384-DbpceXe+nL9tVYPk1HJRh+IIs4i2MIb6abSHXlE0YLEKQY3y1y2PTSUt2RVRIOo9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.1018.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.489.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.489.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h6O2RxilfyazSBzXyoF484/8PxP4ucKcRjquEY1/oEN9g1M+ritYdSJibRkmpXxe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.489.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.489.0/index.min.mjs": "sha384-h6O2RxilfyazSBzXyoF484/8PxP4ucKcRjquEY1/oEN9g1M+ritYdSJibRkmpXxe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.489.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.80.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.80.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jDiC8Z2eWDfmjpiRXgB9nMh9XDAMhOKVZSrhHIC7zsXFRJe94rm9+pc1UQhV/wL1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.80.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.80.0/index.min.mjs": "sha384-jDiC8Z2eWDfmjpiRXgB9nMh9XDAMhOKVZSrhHIC7zsXFRJe94rm9+pc1UQhV/wL1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.80.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.381.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.381.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+vQS8byvHtsAsxVpH0SPoGydSWjbf9BAgQgVrWH4hYkuHdAhza3X0A+/BwKlZ8PV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.381.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.381.0/index.min.mjs": "sha384-+vQS8byvHtsAsxVpH0SPoGydSWjbf9BAgQgVrWH4hYkuHdAhza3X0A+/BwKlZ8PV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.381.0/LICENSE
```

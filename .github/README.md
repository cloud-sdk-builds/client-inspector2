...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.606.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.606.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zY1Fl1i3bZpBdNpn1d/yLljIzQ2W06OXQEGxh0aNqMVKIVJtWzJyDPuEWv2Gql+b
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.606.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.606.0/index.min.mjs": "sha384-zY1Fl1i3bZpBdNpn1d/yLljIzQ2W06OXQEGxh0aNqMVKIVJtWzJyDPuEWv2Gql+b"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.606.0/LICENSE
```

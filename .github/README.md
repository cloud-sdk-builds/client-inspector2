...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.55.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.55.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M4QQAbQFeQyCikgVS5LErvxymAZx0h5XvDawllOx/34aMm/u/O1q/gqDR524lAK9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.55.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.55.0/index.min.mjs": "sha384-M4QQAbQFeQyCikgVS5LErvxymAZx0h5XvDawllOx/34aMm/u/O1q/gqDR524lAK9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.55.0/LICENSE
```

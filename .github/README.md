...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.974.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.974.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RnyFsZuYX91/zDD05Fi4MFLtbDs1+IsMOVug7zADaXGagWikAtSisKEpXxm4zvFi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.974.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.974.0/index.min.mjs": "sha384-RnyFsZuYX91/zDD05Fi4MFLtbDs1+IsMOVug7zADaXGagWikAtSisKEpXxm4zvFi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.974.0/LICENSE
```

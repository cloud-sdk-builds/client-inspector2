...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.54.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.54.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MHbgCG6TRDYt42L/0NzYMlY4CFXXGFnGm2PuJKWEsMgpfs5E0BlNBKsDfpSBICQu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.54.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.54.0/index.min.mjs": "sha384-MHbgCG6TRDYt42L/0NzYMlY4CFXXGFnGm2PuJKWEsMgpfs5E0BlNBKsDfpSBICQu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.54.0/LICENSE
```

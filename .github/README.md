...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.51.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.51.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i60iycEIbb3R8LjHy1LUejeAHaolPqSuVBV4MTdpS1jTMl5tfy8LBkddnZUQxF7j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.51.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.51.0/index.min.mjs": "sha384-i60iycEIbb3R8LjHy1LUejeAHaolPqSuVBV4MTdpS1jTMl5tfy8LBkddnZUQxF7j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.51.0/LICENSE
```

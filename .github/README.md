...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.995.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.995.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PLLKh9qyJquFfdXPXKEr6L1TAPaX3NLNkz7HHXjeyq043Cu1T7ecXkAxm6+6f+PE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.995.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.995.0/index.min.mjs": "sha384-PLLKh9qyJquFfdXPXKEr6L1TAPaX3NLNkz7HHXjeyq043Cu1T7ecXkAxm6+6f+PE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.995.0/LICENSE
```

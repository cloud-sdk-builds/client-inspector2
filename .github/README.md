...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.345.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.345.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/SKrHfYHbAmX7n6zNWGXmKk7ues96QdtRIXvo0hIxISYKtsZjcTqIHuM3wY/rxFn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.345.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.345.0/index.min.mjs": "sha384-/SKrHfYHbAmX7n6zNWGXmKk7ues96QdtRIXvo0hIxISYKtsZjcTqIHuM3wY/rxFn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.345.0/LICENSE
```

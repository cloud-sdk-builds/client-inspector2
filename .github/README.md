...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.958.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.958.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7R8eQeBO3d7Cr7EnVM+UcF8VnT1tiEOQSU4BGMa/Yl3T8XwqpkUZG8oL3glqEpBR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.958.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.958.0/index.min.mjs": "sha384-7R8eQeBO3d7Cr7EnVM+UcF8VnT1tiEOQSU4BGMa/Yl3T8XwqpkUZG8oL3glqEpBR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.958.0/LICENSE
```

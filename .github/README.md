...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.357.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.357.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qFPpXpq18LnvA1blfoOlm0rpV+5imDQGqHQ++ilcfUvElmF6bbd/vsVBdwI98Puv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.357.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.357.0/index.min.mjs": "sha384-qFPpXpq18LnvA1blfoOlm0rpV+5imDQGqHQ++ilcfUvElmF6bbd/vsVBdwI98Puv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.357.0/LICENSE
```

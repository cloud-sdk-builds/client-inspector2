...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.872.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.872.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wYaIZmZ/GuB67nufCcYwwoJPoyriwIpSCM0BEW8VcG+4gXjup8Pe2cpKgntDfczf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.872.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.872.0/index.min.mjs": "sha384-wYaIZmZ/GuB67nufCcYwwoJPoyriwIpSCM0BEW8VcG+4gXjup8Pe2cpKgntDfczf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.872.0/LICENSE
```

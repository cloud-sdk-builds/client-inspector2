...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.529.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.529.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-P5KPMEO1+zoMLunf/EnhasZlCgjXpgeoNmB4UiCAGg4mfvhuXP+mFOlo2dZ84Cmz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.529.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.529.1/index.min.mjs": "sha384-P5KPMEO1+zoMLunf/EnhasZlCgjXpgeoNmB4UiCAGg4mfvhuXP+mFOlo2dZ84Cmz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.529.1/LICENSE
```

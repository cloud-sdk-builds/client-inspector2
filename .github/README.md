...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.386.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.386.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/UdZc2Ya81Cm+L8Bea7aRGxUP6+uQxm4Hn1IV5/xOk4R2R1oSZM9K7In9zBxWoTz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.386.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.386.0/index.min.mjs": "sha384-/UdZc2Ya81Cm+L8Bea7aRGxUP6+uQxm4Hn1IV5/xOk4R2R1oSZM9K7In9zBxWoTz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.386.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.901.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.901.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q3baUim0MO61ARg0jYjJfI30ePeYfvGcEPLj/7+pmMUiCiD5ojJpVfAnRsHBl1Qf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.901.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.901.0/index.min.mjs": "sha384-q3baUim0MO61ARg0jYjJfI30ePeYfvGcEPLj/7+pmMUiCiD5ojJpVfAnRsHBl1Qf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.901.0/LICENSE
```

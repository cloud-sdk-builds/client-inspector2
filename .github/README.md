...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.423.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.423.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Af5GDjw/VUpxyDts9vI8QcPPg2NjCU3kACiyhCsy/hRTYTA0Yp3Mi2XwlbX+M2+d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.423.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.423.0/index.min.mjs": "sha384-Af5GDjw/VUpxyDts9vI8QcPPg2NjCU3kACiyhCsy/hRTYTA0Yp3Mi2XwlbX+M2+d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.423.0/LICENSE
```

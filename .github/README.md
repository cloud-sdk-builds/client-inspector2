...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.896.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.896.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4rs2dkudwa/VCdJVwgb1UVR/LZ3Iuy943bFahUt89sMFQHloaKuhJ+z2MzdSMp7X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.896.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.896.0/index.min.mjs": "sha384-4rs2dkudwa/VCdJVwgb1UVR/LZ3Iuy943bFahUt89sMFQHloaKuhJ+z2MzdSMp7X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.896.0/LICENSE
```

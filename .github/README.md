...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.241.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.241.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JQ+q6jNkXeuKNqbsBxQO2iKDd+6oRcO0pOs6x94kPbUvXhJVVxp9ps5qmOIWEX91
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.241.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.241.0/index.min.mjs": "sha384-JQ+q6jNkXeuKNqbsBxQO2iKDd+6oRcO0pOs6x94kPbUvXhJVVxp9ps5qmOIWEX91"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.241.0/LICENSE
```

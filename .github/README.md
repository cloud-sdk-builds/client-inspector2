...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.47.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.47.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ci8lf0ry6JNI2ms+orPkwdL8uhT0t6fajhEz6asUUaYXl6ISyXHGEfSIVh856Xxw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.47.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.47.0/index.min.mjs": "sha384-Ci8lf0ry6JNI2ms+orPkwdL8uhT0t6fajhEz6asUUaYXl6ISyXHGEfSIVh856Xxw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.47.0/LICENSE
```

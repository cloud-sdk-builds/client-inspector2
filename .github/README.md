...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.262.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.262.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-T4r/t9Nxj9IST8bQqeUyXvLQuz704uExMv/hpe7H22i/op/BqRdLcyyaAICcvWc0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.262.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.262.0/index.min.mjs": "sha384-T4r/t9Nxj9IST8bQqeUyXvLQuz704uExMv/hpe7H22i/op/BqRdLcyyaAICcvWc0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.262.0/LICENSE
```

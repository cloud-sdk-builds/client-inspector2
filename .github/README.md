...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.377.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.377.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CTb4vrCITFegqU5aNlKyE2u/yEDjAECIm+pyb6mbDOM0aYj2R/fo1eqpIDPgaU93
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.377.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.377.0/index.min.mjs": "sha384-CTb4vrCITFegqU5aNlKyE2u/yEDjAECIm+pyb6mbDOM0aYj2R/fo1eqpIDPgaU93"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.377.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.52.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.52.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QxMmVg6NeydY5DN/ByO4vnKG8566uJpRd2HlleuHKPrCzkw4vaZa7oZr8GdSz8+k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.52.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.52.0/index.min.mjs": "sha384-QxMmVg6NeydY5DN/ByO4vnKG8566uJpRd2HlleuHKPrCzkw4vaZa7oZr8GdSz8+k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.52.0/LICENSE
```

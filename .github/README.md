...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.890.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.890.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r8lv/7BZ+CUoW8faqXIm4z4OwTD9GGx97Bc8n1sLzJvahl2xszdpsp+J463Gczng
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.890.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.890.0/index.min.mjs": "sha384-r8lv/7BZ+CUoW8faqXIm4z4OwTD9GGx97Bc8n1sLzJvahl2xszdpsp+J463Gczng"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.890.0/LICENSE
```

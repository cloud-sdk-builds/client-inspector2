...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.798.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.798.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ezJ2b5FWRLQBZmL3aKc8oAU7QbepgWglwp9JGGI2To74/bkchphmM6hLbWMuEIuG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.798.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.798.0/index.min.mjs": "sha384-ezJ2b5FWRLQBZmL3aKc8oAU7QbepgWglwp9JGGI2To74/bkchphmM6hLbWMuEIuG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.798.0/LICENSE
```

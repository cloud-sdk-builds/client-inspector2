...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.1038.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1038.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zUB2p16hHWo/nvEZvhv7C8p7P09mol5YsJuC3+ivaIGr51iptCeaZRzOhU3DWzDE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1038.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1038.0/index.min.mjs": "sha384-zUB2p16hHWo/nvEZvhv7C8p7P09mol5YsJuC3+ivaIGr51iptCeaZRzOhU3DWzDE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.1038.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.662.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.662.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gsTwIbdqdDdJKPrWvIPbSg0aRp0l0sgK8G+AEEQPjH2ApKeTYGSMbuc3JO34V6qQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.662.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.662.0/index.min.mjs": "sha384-gsTwIbdqdDdJKPrWvIPbSg0aRp0l0sgK8G+AEEQPjH2ApKeTYGSMbuc3JO34V6qQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.662.0/LICENSE
```

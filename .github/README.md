...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.256.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.256.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tkcdLbpoKavih/T3goIw12JSNCz9679wkQqwXq0Hdloj46hoV+psAxPsdQwg8I6J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.256.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.256.0/index.min.mjs": "sha384-tkcdLbpoKavih/T3goIw12JSNCz9679wkQqwXq0Hdloj46hoV+psAxPsdQwg8I6J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.256.0/LICENSE
```

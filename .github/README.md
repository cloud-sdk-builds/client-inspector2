...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.211.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.211.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2S+doeo1JIy+y48VnfLN29Y5db9m+VYjieDoEelF1R0PVnh11OFEaBeE6ca4v5hw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.211.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.211.0/index.min.mjs": "sha384-2S+doeo1JIy+y48VnfLN29Y5db9m+VYjieDoEelF1R0PVnh11OFEaBeE6ca4v5hw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.211.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.645.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.645.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0rSZqCCg9Shy0A3MejofcUSYk3iIU4ELA+N0YT8vkE+QOIVMLaPzGc8QlBMP919k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.645.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.645.0/index.min.mjs": "sha384-0rSZqCCg9Shy0A3MejofcUSYk3iIU4ELA+N0YT8vkE+QOIVMLaPzGc8QlBMP919k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.645.0/LICENSE
```

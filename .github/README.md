...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.105.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.105.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Te86nr+6SAH2prtBVPmCAb2P36ad3PSnNo+Phujm9HJdbEckz/Gu+8XeFx35umBc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.105.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.105.0/index.min.mjs": "sha384-Te86nr+6SAH2prtBVPmCAb2P36ad3PSnNo+Phujm9HJdbEckz/Gu+8XeFx35umBc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.105.0/LICENSE
```

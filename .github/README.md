...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.474.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.474.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QBnnxp4grc+EpBau+0aujNPJ2pR3U6zD33V2REmPs0AmPPPY7b1+DUIkvQRyVMvU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.474.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.474.0/index.min.mjs": "sha384-QBnnxp4grc+EpBau+0aujNPJ2pR3U6zD33V2REmPs0AmPPPY7b1+DUIkvQRyVMvU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.474.0/LICENSE
```

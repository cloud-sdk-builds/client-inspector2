...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.970.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.970.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zfX5FxtsLggR9nzb2Akp9LC1WHFsiCwBe9E1itLXzoYL+mDCpdYV0ws2F4TkIQtB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.970.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.970.0/index.min.mjs": "sha384-zfX5FxtsLggR9nzb2Akp9LC1WHFsiCwBe9E1itLXzoYL+mDCpdYV0ws2F4TkIQtB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.970.0/LICENSE
```

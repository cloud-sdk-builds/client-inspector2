...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.429.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.429.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ak+LDMr0TFlXN9ImCtCb8K8/kt8XoPE7Fbm8tn+aCi/cFTzJ/B6d1jNhhAb/Qpox
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.429.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.429.0/index.min.mjs": "sha384-ak+LDMr0TFlXN9ImCtCb8K8/kt8XoPE7Fbm8tn+aCi/cFTzJ/B6d1jNhhAb/Qpox"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.429.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.990.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.990.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZzCI7qV6nOMQpej//zNU3pAWgFAjNbZYaZ6xh7mZBdPGGCtWjP3a7t2jcuWunylT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.990.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.990.0/index.min.mjs": "sha384-ZzCI7qV6nOMQpej//zNU3pAWgFAjNbZYaZ6xh7mZBdPGGCtWjP3a7t2jcuWunylT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.990.0/LICENSE
```

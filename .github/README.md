...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.651.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.651.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-iXGrThNHCdlYbjXznJcwv4nVAfbIsLyRogf7IJnIOuv23En3AkdT3PgGlsJdjcv6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.651.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.651.1/index.min.mjs": "sha384-iXGrThNHCdlYbjXznJcwv4nVAfbIsLyRogf7IJnIOuv23En3AkdT3PgGlsJdjcv6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.651.1/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.940.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.940.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C7FTIlZ8Y1BfIAu1MBBQNmksv0La6PHKxz+6eko0BK6doty1UBrtqbHXHMS4tlJa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.940.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.940.0/index.min.mjs": "sha384-C7FTIlZ8Y1BfIAu1MBBQNmksv0La6PHKxz+6eko0BK6doty1UBrtqbHXHMS4tlJa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.940.0/LICENSE
```

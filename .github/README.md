...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.49.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.49.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hnySJ6g8rhgb5X5/s5eF501HahMO1gmRQGvdf0XP8e2kOMjNN9eWPl+U9OaeydWd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.49.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.49.0/index.min.mjs": "sha384-hnySJ6g8rhgb5X5/s5eF501HahMO1gmRQGvdf0XP8e2kOMjNN9eWPl+U9OaeydWd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.49.0/LICENSE
```

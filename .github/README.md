...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.45.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.45.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z2CAdI6bnVJiAB6s4JGxAHomuGTzKf93vwHdDVprH/L3djx39q7YVSa3TXV9rWDi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.45.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.45.0/index.min.mjs": "sha384-Z2CAdI6bnVJiAB6s4JGxAHomuGTzKf93vwHdDVprH/L3djx39q7YVSa3TXV9rWDi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.45.0/LICENSE
```

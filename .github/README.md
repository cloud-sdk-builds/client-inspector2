...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.327.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.327.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k71zBXYCnoVmHnsXyJ8Qqs31/0W+aajCht6gqD6WHPev8BsZc73gSDikz+v5Y/pU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.327.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.327.0/index.min.mjs": "sha384-k71zBXYCnoVmHnsXyJ8Qqs31/0W+aajCht6gqD6WHPev8BsZc73gSDikz+v5Y/pU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.327.0/LICENSE
```

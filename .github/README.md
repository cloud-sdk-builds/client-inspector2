...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.649.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.649.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EcjnjJ3rwqo0Da6aK0+/4IF7djwz2W4O5cYWadMZYSFy4LPjYrqNwn8aQcvWXShU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.649.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.649.0/index.min.mjs": "sha384-EcjnjJ3rwqo0Da6aK0+/4IF7djwz2W4O5cYWadMZYSFy4LPjYrqNwn8aQcvWXShU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.649.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.421.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.421.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CFP7xJyoLuLRgT3QGmS6vQGDd1NyEIvb4AywhDL280llI414bkg12gmqRoXCn8CI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.421.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.421.0/index.min.mjs": "sha384-CFP7xJyoLuLRgT3QGmS6vQGDd1NyEIvb4AywhDL280llI414bkg12gmqRoXCn8CI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.421.0/LICENSE
```

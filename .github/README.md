...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.344.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.344.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WH+hH9SVxLb2qNsVoJ38M3CFpYJ5nvi2D5e9fPSP2dcxq6Y6bpc9t1Pq6dr8YzZp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.344.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.344.0/index.min.mjs": "sha384-WH+hH9SVxLb2qNsVoJ38M3CFpYJ5nvi2D5e9fPSP2dcxq6Y6bpc9t1Pq6dr8YzZp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.344.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.264.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.264.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-H0pEOktZ95krJjhoXReJYV2dUkEiX9kjCc2NN1b+kg5QKUQgU2r9UDw7LPxbCDlv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.264.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.264.0/index.min.mjs": "sha384-H0pEOktZ95krJjhoXReJYV2dUkEiX9kjCc2NN1b+kg5QKUQgU2r9UDw7LPxbCDlv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.264.0/LICENSE
```

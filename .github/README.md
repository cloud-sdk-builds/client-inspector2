...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.758.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.758.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MCRw8sN3lsDkU6ThpqT1JvZUTtM+dGOvmTaTQtdaAl8C25kd59PNt4dmB4vfNLNn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.758.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.758.0/index.min.mjs": "sha384-MCRw8sN3lsDkU6ThpqT1JvZUTtM+dGOvmTaTQtdaAl8C25kd59PNt4dmB4vfNLNn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.758.0/LICENSE
```

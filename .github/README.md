...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.288.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.288.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4ZZ/k8QC+7qWqgMXB8JuMpRycnrkWwRLpXCrHMD1SUoNiv4CQ7rSLqQqGwWCtxCt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.288.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.288.0/index.min.mjs": "sha384-4ZZ/k8QC+7qWqgMXB8JuMpRycnrkWwRLpXCrHMD1SUoNiv4CQ7rSLqQqGwWCtxCt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.288.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.696.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.696.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Zuzin3rS0BHrEjLPFUSHJyEryW5t1PdAzNvJARaz8LtcnaM4SD2/gIn8w2AZiIA0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.696.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.696.0/index.min.mjs": "sha384-Zuzin3rS0BHrEjLPFUSHJyEryW5t1PdAzNvJARaz8LtcnaM4SD2/gIn8w2AZiIA0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.696.0/LICENSE
```

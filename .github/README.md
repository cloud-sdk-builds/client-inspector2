...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.316.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.316.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oVvdItJG3VlFEAmBmWkjWNVwuNIQZOh3uj0v0UAF4CPj81SnAauJ32j1aoSmXFc0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.316.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.316.0/index.min.mjs": "sha384-oVvdItJG3VlFEAmBmWkjWNVwuNIQZOh3uj0v0UAF4CPj81SnAauJ32j1aoSmXFc0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.316.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.523.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.523.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GgjSc6WkdTGpBqXdMdo4Z01ts8UYBL1NgSDbOI7wzv+kghK3GyH204HNEF4JTDl8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.523.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.523.0/index.min.mjs": "sha384-GgjSc6WkdTGpBqXdMdo4Z01ts8UYBL1NgSDbOI7wzv+kghK3GyH204HNEF4JTDl8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.523.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.679.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.679.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OSjYL0xgNIYothvX2RoTLYF5/E3Kf2f34n4g0Dbp9Y+fEmr29/i+jorpuNekYsSe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.679.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.679.0/index.min.mjs": "sha384-OSjYL0xgNIYothvX2RoTLYF5/E3Kf2f34n4g0Dbp9Y+fEmr29/i+jorpuNekYsSe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.679.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.624.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.624.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FEZEzMmLHencpPMkuS0J/fGkZHhEM/MU2GOWQW3EJAMDqb8/1ENC1uub/8NO2FN/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.624.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.624.0/index.min.mjs": "sha384-FEZEzMmLHencpPMkuS0J/fGkZHhEM/MU2GOWQW3EJAMDqb8/1ENC1uub/8NO2FN/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.624.0/LICENSE
```

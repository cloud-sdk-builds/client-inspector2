...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.835.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.835.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+j0kyRSmegLDczwh2P+Y6eG4IDR0UQcgrwDPDP5mJdCT7xBhiHz6WOVlFEcfuiYU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.835.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.835.0/index.min.mjs": "sha384-+j0kyRSmegLDczwh2P+Y6eG4IDR0UQcgrwDPDP5mJdCT7xBhiHz6WOVlFEcfuiYU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.835.0/LICENSE
```

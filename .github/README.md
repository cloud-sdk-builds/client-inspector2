...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.398.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.398.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SC89pgJeuHjHLj0ILDh28DLqGnR8TbX9KWne+cil51AziVkPmLx2eN3Xik8xWgXT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.398.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.398.0/index.min.mjs": "sha384-SC89pgJeuHjHLj0ILDh28DLqGnR8TbX9KWne+cil51AziVkPmLx2eN3Xik8xWgXT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.398.0/LICENSE
```

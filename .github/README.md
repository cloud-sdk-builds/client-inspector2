...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.53.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.53.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r6dAHGe/obcom9p59spgNYDOvOulOVDHg42WYc2qrHlkCI43Pa+p+SibOnkOep09
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.53.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.53.0/index.min.mjs": "sha384-r6dAHGe/obcom9p59spgNYDOvOulOVDHg42WYc2qrHlkCI43Pa+p+SibOnkOep09"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.53.0/LICENSE
```

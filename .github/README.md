...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.916.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.916.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5SKdhHa3/8u6fB8I9GYxAEUQP+4Q4C71OiUCt0FOrbPBrfRNt6R0C/EjJ5RIJNHp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.916.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.916.0/index.min.mjs": "sha384-5SKdhHa3/8u6fB8I9GYxAEUQP+4Q4C71OiUCt0FOrbPBrfRNt6R0C/EjJ5RIJNHp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.916.0/LICENSE
```

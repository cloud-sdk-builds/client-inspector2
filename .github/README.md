...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.726.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.726.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Qh0xZACIw2Z2gePVkWDm/UMReli+f0w0FNykqfbn3/SxbjQcd9+JEJVMCWa1FE7Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.726.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.726.0/index.min.mjs": "sha384-Qh0xZACIw2Z2gePVkWDm/UMReli+f0w0FNykqfbn3/SxbjQcd9+JEJVMCWa1FE7Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.726.0/LICENSE
```

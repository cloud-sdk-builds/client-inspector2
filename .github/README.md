...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.326.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.326.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-D3iHM+W6+wQuljsmRadj5vA6/dm5twRekQyKXaNc2SoYYoNAveL5xbEkaUXwPna5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.326.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.326.0/index.min.mjs": "sha384-D3iHM+W6+wQuljsmRadj5vA6/dm5twRekQyKXaNc2SoYYoNAveL5xbEkaUXwPna5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.326.0/LICENSE
```

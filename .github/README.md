...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.347.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.347.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-jfFx0Vs85/2fLXeDNju9iofUeTBOjOLjeR8bnCr5tbmLhp2jw4GrgKd/WbvlEptf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.347.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.347.1/index.min.mjs": "sha384-jfFx0Vs85/2fLXeDNju9iofUeTBOjOLjeR8bnCr5tbmLhp2jw4GrgKd/WbvlEptf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.347.1/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.359.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.359.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rz5JPeV7K8gezRkAOjk+ORQ2++mx996UAkvoZGV5VEWVOqrm5f/5MXGmfNUkBaRk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.359.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.359.0/index.min.mjs": "sha384-rz5JPeV7K8gezRkAOjk+ORQ2++mx996UAkvoZGV5VEWVOqrm5f/5MXGmfNUkBaRk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.359.0/LICENSE
```

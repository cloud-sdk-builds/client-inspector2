...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.321.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.321.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-NUUOygmj8PRgugUdL/kmFqzxR2xtccFavhquo73gtwxu8RCz2Q3LaASwSVWLC/9a
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.321.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.321.1/index.min.mjs": "sha384-NUUOygmj8PRgugUdL/kmFqzxR2xtccFavhquo73gtwxu8RCz2Q3LaASwSVWLC/9a"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.321.1/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.919.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.919.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eFHpTBboTQDJqp3oMO4SRqY4zrAv7z7XLD2IMzURgR3F5WQIGSg9+N8oV24nqUcB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.919.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.919.0/index.min.mjs": "sha384-eFHpTBboTQDJqp3oMO4SRqY4zrAv7z7XLD2IMzURgR3F5WQIGSg9+N8oV24nqUcB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.919.0/LICENSE
```

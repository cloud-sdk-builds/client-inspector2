...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.218.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.218.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KTfBvTWhZ3qnvUsRCq6adoZmpIQX3lEAz2PlMnYUfTg1CYc197bvejOHxNE+ogkQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.218.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.218.0/index.min.mjs": "sha384-KTfBvTWhZ3qnvUsRCq6adoZmpIQX3lEAz2PlMnYUfTg1CYc197bvejOHxNE+ogkQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.218.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.100.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.100.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hPT31RmWZ8D/tscvOfMfSu0qsMK1oMNlM0xwRnHmrh+RzH5AOPHg/wZPuGjycgc6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.100.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.100.0/index.min.mjs": "sha384-hPT31RmWZ8D/tscvOfMfSu0qsMK1oMNlM0xwRnHmrh+RzH5AOPHg/wZPuGjycgc6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.100.0/LICENSE
```

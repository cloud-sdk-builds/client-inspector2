...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.668.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.668.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ijudwKxYN8erhNHdTAd4b7FbHTjnoE98QxHCENe7hJh4jfWuXbGKjKOj/+hN2+so
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.668.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.668.0/index.min.mjs": "sha384-ijudwKxYN8erhNHdTAd4b7FbHTjnoE98QxHCENe7hJh4jfWuXbGKjKOj/+hN2+so"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.668.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.458.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.458.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m+anuVeY2f+OxOCvnYBLSsGiHczVI5Ibv0m3+YQOApAt69Sn77VSjw3rVf5wsV0K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.458.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.458.0/index.min.mjs": "sha384-m+anuVeY2f+OxOCvnYBLSsGiHczVI5Ibv0m3+YQOApAt69Sn77VSjw3rVf5wsV0K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.458.0/LICENSE
```

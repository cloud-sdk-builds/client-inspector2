...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.954.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.954.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oS/f6F98aNBrE1g2P8eLGhMOfwP3lPZrevSM74yQg2Bal44ChhFVPMS4YwdUOFpd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.954.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.954.0/index.min.mjs": "sha384-oS/f6F98aNBrE1g2P8eLGhMOfwP3lPZrevSM74yQg2Bal44ChhFVPMS4YwdUOFpd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.954.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.713.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.713.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eQPiJgP93aZt1ct/Jm1Zg1Cv2pKQTQMEKH5ZvchxImuOkQYhSQIXn1lbTELNEcCt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.713.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.713.0/index.min.mjs": "sha384-eQPiJgP93aZt1ct/Jm1Zg1Cv2pKQTQMEKH5ZvchxImuOkQYhSQIXn1lbTELNEcCt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.713.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.306.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.306.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C9Q60YFwUgSdDEGEsd1e0Tdtr+tlK5bXIwvlfYM5KKYssQkamCHkbJK69GRFG9M1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.306.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.306.0/index.min.mjs": "sha384-C9Q60YFwUgSdDEGEsd1e0Tdtr+tlK5bXIwvlfYM5KKYssQkamCHkbJK69GRFG9M1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.306.0/LICENSE
```

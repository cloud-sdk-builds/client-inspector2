...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.980.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.980.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m6KJsKSMHBZ101n09Ooz0SrLsMAlL5R2FerYEjUKOxcCHvryh+/MwCJJgis/rJHp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.980.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.980.0/index.min.mjs": "sha384-m6KJsKSMHBZ101n09Ooz0SrLsMAlL5R2FerYEjUKOxcCHvryh+/MwCJJgis/rJHp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.980.0/LICENSE
```

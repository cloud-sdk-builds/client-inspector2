...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.67.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.67.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RkiZga7E7iT6RZHO1qfzAqW3WLDw+Y9I9eAVCnuT0cXl0vGGBiRz5MvdaCFPBJuu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.67.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.67.0/index.min.mjs": "sha384-RkiZga7E7iT6RZHO1qfzAqW3WLDw+Y9I9eAVCnuT0cXl0vGGBiRz5MvdaCFPBJuu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.67.0/LICENSE
```

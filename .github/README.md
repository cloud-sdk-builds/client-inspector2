...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.826.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.826.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HwPhA0g4xunODT5zV1P1hd8Igqe0zhcZrhyDvlnVgJLTVB6XdE6WZg1QkaLJ/dtM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.826.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.826.0/index.min.mjs": "sha384-HwPhA0g4xunODT5zV1P1hd8Igqe0zhcZrhyDvlnVgJLTVB6XdE6WZg1QkaLJ/dtM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.826.0/LICENSE
```

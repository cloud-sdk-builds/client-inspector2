...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.899.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.899.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+PiKpQLtwXQeSH6FJrldZMmeUyHC6a9Iso2MZiuK44ZOlLLznhBv5DEr9WOOUALP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.899.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.899.0/index.min.mjs": "sha384-+PiKpQLtwXQeSH6FJrldZMmeUyHC6a9Iso2MZiuK44ZOlLLznhBv5DEr9WOOUALP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.899.0/LICENSE
```

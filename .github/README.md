...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.428.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.428.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NWbIah6CMgVPuRqz7MlXrTXabRrp0lu7Ubst5FkaJ8ryeXqoIx8OZztVdemfyz83
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.428.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.428.0/index.min.mjs": "sha384-NWbIah6CMgVPuRqz7MlXrTXabRrp0lu7Ubst5FkaJ8ryeXqoIx8OZztVdemfyz83"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.428.0/LICENSE
```

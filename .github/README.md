...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.271.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.271.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uubNGSF0Ifrai9q+AZvCCZqbIt8kgT6pLSA5Nus/WGRfBxJbxw6H/9LiCmG7qCp2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.271.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.271.0/index.min.mjs": "sha384-uubNGSF0Ifrai9q+AZvCCZqbIt8kgT6pLSA5Nus/WGRfBxJbxw6H/9LiCmG7qCp2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.271.0/LICENSE
```

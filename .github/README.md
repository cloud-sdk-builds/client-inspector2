...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.478.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.478.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-B+b5s59lPAvqYt4IMWZ0Rs1xeH5VwrPxwcwmf4lVvrA1xrRDJyTGJvIrwyTng2dH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.478.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.478.0/index.min.mjs": "sha384-B+b5s59lPAvqYt4IMWZ0Rs1xeH5VwrPxwcwmf4lVvrA1xrRDJyTGJvIrwyTng2dH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.478.0/LICENSE
```

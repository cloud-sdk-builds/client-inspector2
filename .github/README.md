...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.168.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.168.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6ZNdzqULkiKrqGe2gKolh2+/8chbXhPg1KimTkM1d4tqlYymMU1a6IX9mT0Ix/UH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.168.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.168.0/index.min.mjs": "sha384-6ZNdzqULkiKrqGe2gKolh2+/8chbXhPg1KimTkM1d4tqlYymMU1a6IX9mT0Ix/UH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.168.0/LICENSE
```

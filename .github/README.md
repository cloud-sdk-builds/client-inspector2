...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.278.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.278.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-P9qZg+1+Ym+maV4PSQCSj+FtAu8OAQuVu57z5eUXyehnLDZWvIOLXOFeT4gavdvx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.278.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.278.0/index.min.mjs": "sha384-P9qZg+1+Ym+maV4PSQCSj+FtAu8OAQuVu57z5eUXyehnLDZWvIOLXOFeT4gavdvx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.278.0/LICENSE
```

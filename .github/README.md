...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.582.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.582.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Bl0+vgjbQAEtC5IE8BJ7JY9Ty/PDoMOga1LwpJvP1y5Y99xJTgrG9ulPQdntoLQu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.582.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.582.0/index.min.mjs": "sha384-Bl0+vgjbQAEtC5IE8BJ7JY9Ty/PDoMOga1LwpJvP1y5Y99xJTgrG9ulPQdntoLQu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.582.0/LICENSE
```

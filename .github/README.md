...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.223.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.223.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2Jtk/JFuDS7YGPTXw0NUcUqRysHiKERH9HH2giVU+Ml7LqDjtZi8e/P69MJot+Xn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.223.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.223.0/index.min.mjs": "sha384-2Jtk/JFuDS7YGPTXw0NUcUqRysHiKERH9HH2giVU+Ml7LqDjtZi8e/P69MJot+Xn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.223.0/LICENSE
```

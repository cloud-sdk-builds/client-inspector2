...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.462.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.462.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cEPaKWBhyQdWvlzmXyx7ohk1fxGhpBQNRw5HJlXB/5utXUd5RGH/9nCSAwVKxgS6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.462.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.462.0/index.min.mjs": "sha384-cEPaKWBhyQdWvlzmXyx7ohk1fxGhpBQNRw5HJlXB/5utXUd5RGH/9nCSAwVKxgS6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.462.0/LICENSE
```

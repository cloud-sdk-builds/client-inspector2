...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.454.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.454.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OFakIEpfllDTd4yTghXlm1z8hnE1gPmDC2r1Dr9smf9El1284TtXj8YEfgQ7fMKV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.454.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.454.0/index.min.mjs": "sha384-OFakIEpfllDTd4yTghXlm1z8hnE1gPmDC2r1Dr9smf9El1284TtXj8YEfgQ7fMKV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.454.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.196.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.196.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hcfj2O/I4sNSIK7+KohY9vzRS6zXmJrFeLV8D/EKEq9ZgL/+rmipV3BXbMhmtRBL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.196.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.196.0/index.min.mjs": "sha384-hcfj2O/I4sNSIK7+KohY9vzRS6zXmJrFeLV8D/EKEq9ZgL/+rmipV3BXbMhmtRBL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.196.0/LICENSE
```

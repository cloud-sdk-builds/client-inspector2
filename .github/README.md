...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.986.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.986.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Spzb3bBehD1QtHX8d/CNRdvIb/ZC2laQT27bkhAnDNrAiG6C9RsPm/rvlBjmBSSt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.986.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.986.0/index.min.mjs": "sha384-Spzb3bBehD1QtHX8d/CNRdvIb/ZC2laQT27bkhAnDNrAiG6C9RsPm/rvlBjmBSSt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.986.0/LICENSE
```

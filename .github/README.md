...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.1031.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1031.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EFr+joTpt7vKg/8PpO8PqpsJ3tctEs0dTPVxESl0U4RTzFaxztfvIMTQc+ssUNu9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1031.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1031.0/index.min.mjs": "sha384-EFr+joTpt7vKg/8PpO8PqpsJ3tctEs0dTPVxESl0U4RTzFaxztfvIMTQc+ssUNu9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.1031.0/LICENSE
```

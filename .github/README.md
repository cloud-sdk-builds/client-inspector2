...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.476.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.476.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xnPzsT/VRuJMjf0J3n1fWuHP+2utktn+YYq5SFXD9BdOGzhffCOxAgEVDsbmhrJR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.476.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.476.0/index.min.mjs": "sha384-xnPzsT/VRuJMjf0J3n1fWuHP+2utktn+YYq5SFXD9BdOGzhffCOxAgEVDsbmhrJR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.476.0/LICENSE
```

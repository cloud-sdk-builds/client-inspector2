...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.895.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.895.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QGvMPLTo96QfqFwB263gM4DiT+ZWYpxIR0lpAnOuyxkmE7t5f9IGzk/jqb17pArT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.895.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.895.0/index.min.mjs": "sha384-QGvMPLTo96QfqFwB263gM4DiT+ZWYpxIR0lpAnOuyxkmE7t5f9IGzk/jqb17pArT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.895.0/LICENSE
```

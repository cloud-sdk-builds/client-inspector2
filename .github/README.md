...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.554.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.554.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2RxayZabUha6r+Y946rihHM+7Qrc7jXO1VBKxBYSPE4cKtThRUhpHbIdwTmfgPC/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.554.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.554.0/index.min.mjs": "sha384-2RxayZabUha6r+Y946rihHM+7Qrc7jXO1VBKxBYSPE4cKtThRUhpHbIdwTmfgPC/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.554.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.810.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.810.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GvY7E4Wtz1yyKOd4QQgfmJHSaOAqazsjY37vrjDEL1cA+vyU2NeVrNtdQaGSslLi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.810.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.810.0/index.min.mjs": "sha384-GvY7E4Wtz1yyKOd4QQgfmJHSaOAqazsjY37vrjDEL1cA+vyU2NeVrNtdQaGSslLi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.810.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.620.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.620.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-r8w17yOIoWJoV7v1U2Ly7UVYBvfda5Yso1+NaLZcMa/FTCP9ULQD4bVHtwYAaves
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.620.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.620.1/index.min.mjs": "sha384-r8w17yOIoWJoV7v1U2Ly7UVYBvfda5Yso1+NaLZcMa/FTCP9ULQD4bVHtwYAaves"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.620.1/LICENSE
```

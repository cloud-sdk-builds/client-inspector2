...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.774.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.774.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-86C91SHytywtwRHRHu6/RNW3e8BZ9Nt7wBorQAKrQwBQqQhSC9d4lfDti0k0Qz3A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.774.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.774.0/index.min.mjs": "sha384-86C91SHytywtwRHRHu6/RNW3e8BZ9Nt7wBorQAKrQwBQqQhSC9d4lfDti0k0Qz3A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.774.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.886.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.886.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uyrv9ISZVq52Nv/smwdDqegQkR6LSinrQJ1cVcybkIcEK1TnyqpfLrc5EGaM9MMv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.886.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.886.0/index.min.mjs": "sha384-uyrv9ISZVq52Nv/smwdDqegQkR6LSinrQJ1cVcybkIcEK1TnyqpfLrc5EGaM9MMv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.886.0/LICENSE
```

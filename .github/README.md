...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.609.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.609.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-T9WKmS6sQ4kcBxVUCDTQl+H2Cs0Z83wGz1Z5Yw8CS1yjRCK9Avde3orlvqfxC1OI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.609.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.609.0/index.min.mjs": "sha384-T9WKmS6sQ4kcBxVUCDTQl+H2Cs0Z83wGz1Z5Yw8CS1yjRCK9Avde3orlvqfxC1OI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.609.0/LICENSE
```

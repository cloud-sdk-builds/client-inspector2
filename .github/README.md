...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.817.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.817.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-coGYDIE7ZmKfo0NKeHBYuVKYV5+zxw5FH/Ufgt6l67TXEB2HsIPI3wRkwvLpBcLX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.817.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.817.0/index.min.mjs": "sha384-coGYDIE7ZmKfo0NKeHBYuVKYV5+zxw5FH/Ufgt6l67TXEB2HsIPI3wRkwvLpBcLX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.817.0/LICENSE
```

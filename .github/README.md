...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.46.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.46.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9IW7KZkSyqjE26u95Sw5jqTx1240ScwCslpsKTroukNtyPRn3HQSE1oH1cqIk//8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.46.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.46.0/index.min.mjs": "sha384-9IW7KZkSyqjE26u95Sw5jqTx1240ScwCslpsKTroukNtyPRn3HQSE1oH1cqIk//8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.46.0/LICENSE
```

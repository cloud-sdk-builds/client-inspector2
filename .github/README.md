...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.127.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.127.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AJB6CRKK7w7rRyvVDBXLs3TyjnLK79nRdtQQSWs11OH0uD08xdu6wJah72E+bD+7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.127.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.127.0/index.min.mjs": "sha384-AJB6CRKK7w7rRyvVDBXLs3TyjnLK79nRdtQQSWs11OH0uD08xdu6wJah72E+bD+7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.127.0/LICENSE
```

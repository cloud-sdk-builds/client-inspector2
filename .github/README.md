...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.266.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.266.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9f3px8m0I5j+iN5MmhKiTAEgFW/wCfquQU9yRD1Amtt4Bp+4llCjZQb6qw5AVIxQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.266.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.266.0/index.min.mjs": "sha384-9f3px8m0I5j+iN5MmhKiTAEgFW/wCfquQU9yRD1Amtt4Bp+4llCjZQb6qw5AVIxQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.266.0/LICENSE
```

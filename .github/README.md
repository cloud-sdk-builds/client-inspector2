...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.712.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.712.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Nl5ku5ZcuVSsnshpbLg4L99njB/TAnWI6mF4WsMj6jiBkS3s3JSFixGPLyYrHDqH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.712.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.712.0/index.min.mjs": "sha384-Nl5ku5ZcuVSsnshpbLg4L99njB/TAnWI6mF4WsMj6jiBkS3s3JSFixGPLyYrHDqH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.712.0/LICENSE
```

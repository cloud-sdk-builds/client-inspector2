...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.906.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.906.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-30RypJ9+hCwJN/puGSEMAlmTeyod0ru8YzwFQogC3k/le3V11NMom8Zh7JDvwhj8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.906.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.906.0/index.min.mjs": "sha384-30RypJ9+hCwJN/puGSEMAlmTeyod0ru8YzwFQogC3k/le3V11NMom8Zh7JDvwhj8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.906.0/LICENSE
```

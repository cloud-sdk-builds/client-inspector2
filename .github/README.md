...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.353.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.353.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Qp0LVPWVq+3zHy+4dbKa1wrgbjH9JTyDbwLMNOTbbNNcZS1uMeyuLbWUMCYFgyZl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.353.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.353.0/index.min.mjs": "sha384-Qp0LVPWVq+3zHy+4dbKa1wrgbjH9JTyDbwLMNOTbbNNcZS1uMeyuLbWUMCYFgyZl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.353.0/LICENSE
```

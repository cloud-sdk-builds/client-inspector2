...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.666.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.666.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QiMt9Sy6KbNkXgduQsYkyybCMj9dyXtAxATtd8NCM4OIGcTFj1ZgM4dTav7xLiG0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.666.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.666.0/index.min.mjs": "sha384-QiMt9Sy6KbNkXgduQsYkyybCMj9dyXtAxATtd8NCM4OIGcTFj1ZgM4dTav7xLiG0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.666.0/LICENSE
```

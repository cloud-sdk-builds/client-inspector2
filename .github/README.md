...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.731.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.731.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-Y4CtjEmBFsIOIq/vCgxqSWogJLIjsH5Pr0C0Tya0QfXaOOcgWut55thmRtoKWm+N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.731.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.731.1/index.min.mjs": "sha384-Y4CtjEmBFsIOIq/vCgxqSWogJLIjsH5Pr0C0Tya0QfXaOOcgWut55thmRtoKWm+N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.731.1/LICENSE
```

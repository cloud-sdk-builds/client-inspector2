...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.56.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.56.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QOyR/2EqXOOt6lbhxLMjKcwp80E8pyqrArMGpmIyXX84S8iaDHsA/Cur1hSeqqCm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.56.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.56.0/index.min.mjs": "sha384-QOyR/2EqXOOt6lbhxLMjKcwp80E8pyqrArMGpmIyXX84S8iaDHsA/Cur1hSeqqCm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.56.0/LICENSE
```

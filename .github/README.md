...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.188.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.188.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NDjeYoT8EU6Y5jWzn1lJ1BLlTqHP4X0Or6DTppevF5zJAuUWEk5YcZEPCsp1DLOY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.188.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.188.0/index.min.mjs": "sha384-NDjeYoT8EU6Y5jWzn1lJ1BLlTqHP4X0Or6DTppevF5zJAuUWEk5YcZEPCsp1DLOY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.188.0/LICENSE
```

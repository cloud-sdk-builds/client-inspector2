...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.150.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.150.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ix3Y+DlKCMVHf8uYrq9mRzAxJLml/iu2F0kPAEGmRhCFlhuwvoMlMSOFs0cpE1GR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.150.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.150.0/index.min.mjs": "sha384-Ix3Y+DlKCMVHf8uYrq9mRzAxJLml/iu2F0kPAEGmRhCFlhuwvoMlMSOFs0cpE1GR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.150.0/LICENSE
```

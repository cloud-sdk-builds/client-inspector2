...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.303.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.303.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7HHhZuizttmi+hDzXg3LaJdT8nwrZ+H9Q7t2AlpKSunSwNlwvs5Cx4KItdu2e40a
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.303.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.303.0/index.min.mjs": "sha384-7HHhZuizttmi+hDzXg3LaJdT8nwrZ+H9Q7t2AlpKSunSwNlwvs5Cx4KItdu2e40a"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.303.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.194.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.194.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RZJcG19w/2bZP+RpGqqDIfdKsnxKSOOqvQfQZTczsV4rowBhlDPJWgNLMFK2ig9b
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.194.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.194.0/index.min.mjs": "sha384-RZJcG19w/2bZP+RpGqqDIfdKsnxKSOOqvQfQZTczsV4rowBhlDPJWgNLMFK2ig9b"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.194.0/LICENSE
```

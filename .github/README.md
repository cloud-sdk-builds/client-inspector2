...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.876.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.876.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nda4lMPXeqzlGSYZs2utPMdjUXXBP4rJvQ+1SieKqcRiHRE9wqBHNaU1/ZUKG8QZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.876.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.876.0/index.min.mjs": "sha384-nda4lMPXeqzlGSYZs2utPMdjUXXBP4rJvQ+1SieKqcRiHRE9wqBHNaU1/ZUKG8QZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.876.0/LICENSE
```

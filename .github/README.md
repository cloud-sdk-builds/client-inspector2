...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.498.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.498.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1X6akVX8ZcOuOedJ170k+uaygpjs8UszhLo3LlCb31IG/i+0bklpQCiSKhsMZ82m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.498.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.498.0/index.min.mjs": "sha384-1X6akVX8ZcOuOedJ170k+uaygpjs8UszhLo3LlCb31IG/i+0bklpQCiSKhsMZ82m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.498.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.978.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.978.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-j5WBtshYbvsCGOUdeBUWxS1Jfa3z+Szg/WYKsrFHJwbSZiDTXZSrM+nKQX8hebQ3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.978.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.978.0/index.min.mjs": "sha384-j5WBtshYbvsCGOUdeBUWxS1Jfa3z+Szg/WYKsrFHJwbSZiDTXZSrM+nKQX8hebQ3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.978.0/LICENSE
```

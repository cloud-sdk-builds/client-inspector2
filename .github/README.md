...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.1024.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1024.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LyvPJ2GRwzpXg8PpoJ+qTcgUB+lJYzUzQac7YzSw2H59XrzCLyDcQlLCZPn8cQBu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1024.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1024.0/index.min.mjs": "sha384-LyvPJ2GRwzpXg8PpoJ+qTcgUB+lJYzUzQac7YzSw2H59XrzCLyDcQlLCZPn8cQBu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.1024.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.992.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.992.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Rp8oOPhkIQLGQYv0T5u/tffy1CTvNtFd+btESeeMgIdKliIWRj08QKq5Bn7tO7H3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.992.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.992.0/index.min.mjs": "sha384-Rp8oOPhkIQLGQYv0T5u/tffy1CTvNtFd+btESeeMgIdKliIWRj08QKq5Bn7tO7H3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.992.0/LICENSE
```

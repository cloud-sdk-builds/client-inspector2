...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.145.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.145.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KLvT5o5dHz9vDfish2shQ/RO4xzNUeFDHxSKmyrMeHTKsBUTukvTsERQtt8bWpgq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.145.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.145.0/index.min.mjs": "sha384-KLvT5o5dHz9vDfish2shQ/RO4xzNUeFDHxSKmyrMeHTKsBUTukvTsERQtt8bWpgq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.145.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.499.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.499.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WP4VWenFC2kwaR2PkV8RkvFdl4/aN+kPsLm4ECxcvEPvDYe5nmkIyLQEtmzPyQB4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.499.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.499.0/index.min.mjs": "sha384-WP4VWenFC2kwaR2PkV8RkvFdl4/aN+kPsLm4ECxcvEPvDYe5nmkIyLQEtmzPyQB4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.499.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.590.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.590.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xan/KJciwVFT/8cJJFvvfMH/2Y+EcwYbPoRVdCL8D7l7+5IHs3zYyAD4lrwMR9sj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.590.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.590.0/index.min.mjs": "sha384-xan/KJciwVFT/8cJJFvvfMH/2Y+EcwYbPoRVdCL8D7l7+5IHs3zYyAD4lrwMR9sj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.590.0/LICENSE
```

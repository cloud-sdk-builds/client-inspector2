...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.972.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.972.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GGO2EHyWid+kmQ4dfbA9RYebcLNwVhmP+i0WOm7UYDjRFfxUAe9BIuA9LKhKfwMz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.972.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.972.0/index.min.mjs": "sha384-GGO2EHyWid+kmQ4dfbA9RYebcLNwVhmP+i0WOm7UYDjRFfxUAe9BIuA9LKhKfwMz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.972.0/LICENSE
```

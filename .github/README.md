...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.445.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.445.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QJInUGAR5hmJn0qJUxWkpyCx/5HaSG3wauH8oLOnhNnYmr5kWAi4OEDsro6fgdNZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.445.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.445.0/index.min.mjs": "sha384-QJInUGAR5hmJn0qJUxWkpyCx/5HaSG3wauH8oLOnhNnYmr5kWAi4OEDsro6fgdNZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.445.0/LICENSE
```

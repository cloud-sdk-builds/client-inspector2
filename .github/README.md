...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.667.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.667.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N46xyejHkbIU52V8s/RZRfZk9S6eJUDyh3+JLJN3jYsYeW6frrUG6ER85khPsTjY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.667.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.667.0/index.min.mjs": "sha384-N46xyejHkbIU52V8s/RZRfZk9S6eJUDyh3+JLJN3jYsYeW6frrUG6ER85khPsTjY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.667.0/LICENSE
```

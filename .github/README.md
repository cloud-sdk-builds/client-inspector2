...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.44.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.44.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vcv4vg1r6CQBabj/0mVkIna65Bbvp6RFhrEVe6MUIYyzO0FlX5bZPE0h8ssm0CP6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.44.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.44.0/index.min.mjs": "sha384-vcv4vg1r6CQBabj/0mVkIna65Bbvp6RFhrEVe6MUIYyzO0FlX5bZPE0h8ssm0CP6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.44.0/LICENSE
```

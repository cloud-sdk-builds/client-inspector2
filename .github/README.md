...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.921.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.921.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u+2+20EIvllhbKyhNpMRQqB/UZx+lVh6l6F6OhTVXwZa7ZjKMaOTdQYgCs15ir0X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.921.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.921.0/index.min.mjs": "sha384-u+2+20EIvllhbKyhNpMRQqB/UZx+lVh6l6F6OhTVXwZa7ZjKMaOTdQYgCs15ir0X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.921.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.47.2).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.47.2/index.min.mjs
```

SRI SHA Hash

```text
sha384-vOD8/YLe4nHnJuhRzXOHoTwCyxRaeLObzkiHk5RFOUSUtrON9siJQhxsI31e73Sa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.47.2/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.47.2/index.min.mjs": "sha384-vOD8/YLe4nHnJuhRzXOHoTwCyxRaeLObzkiHk5RFOUSUtrON9siJQhxsI31e73Sa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.47.2/LICENSE
```

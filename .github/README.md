...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.563.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.563.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cp+lgfxe/H+3irFitnOtd+LNNwByfLep1iyPt+6K4JqLJBrAzNtq/Y3IU/bZTO24
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.563.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.563.0/index.min.mjs": "sha384-cp+lgfxe/H+3irFitnOtd+LNNwByfLep1iyPt+6K4JqLJBrAzNtq/Y3IU/bZTO24"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.563.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.85.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.85.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Vs1iRmRUmAA8bejlmynzKNaav+XdoY7FTt5y1i+LGw6fLa+ATGuPkeWghBv0wYyB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.85.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.85.0/index.min.mjs": "sha384-Vs1iRmRUmAA8bejlmynzKNaav+XdoY7FTt5y1i+LGw6fLa+ATGuPkeWghBv0wYyB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.85.0/LICENSE
```

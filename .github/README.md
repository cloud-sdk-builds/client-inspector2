...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.692.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.692.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jknwGyHqj8B+6okDQBfG23l44eml+6ESwd12/EiXZVa3SoPTsQ2bdos9nXla+5zo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.692.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.692.0/index.min.mjs": "sha384-jknwGyHqj8B+6okDQBfG23l44eml+6ESwd12/EiXZVa3SoPTsQ2bdos9nXla+5zo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.692.0/LICENSE
```

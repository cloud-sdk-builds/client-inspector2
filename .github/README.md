...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.796.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.796.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FLqfBvogRGa5AUumRoipmmb1hnDhVc4Z/FX2S+u5w6Kit8xoAOSP37kO6Cfn2yGc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.796.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.796.0/index.min.mjs": "sha384-FLqfBvogRGa5AUumRoipmmb1hnDhVc4Z/FX2S+u5w6Kit8xoAOSP37kO6Cfn2yGc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.796.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.985.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.985.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ocUxZH68e+B7nyIDXILQtcH4m1GQc8jOJA9EJK78+PIDSb7OJjf6whSkkifIut/M
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.985.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.985.0/index.min.mjs": "sha384-ocUxZH68e+B7nyIDXILQtcH4m1GQc8jOJA9EJK78+PIDSb7OJjf6whSkkifIut/M"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.985.0/LICENSE
```

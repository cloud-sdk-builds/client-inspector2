...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.252.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.252.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-50VOhGnzBf/e45PzqLrUHJom6GOqnNjZmtyi0n7Z+vJSTHnVmPemaH8dGr7xYLDn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.252.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.252.0/index.min.mjs": "sha384-50VOhGnzBf/e45PzqLrUHJom6GOqnNjZmtyi0n7Z+vJSTHnVmPemaH8dGr7xYLDn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.252.0/LICENSE
```

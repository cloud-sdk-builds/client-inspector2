...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.259.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.259.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZGZCC7a2f4lWQMGlFGjN96scuY0ehxHLtjp7u7RwENvh+uHR6zKFwAUX3hN0tmTh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.259.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.259.0/index.min.mjs": "sha384-ZGZCC7a2f4lWQMGlFGjN96scuY0ehxHLtjp7u7RwENvh+uHR6zKFwAUX3hN0tmTh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.259.0/LICENSE
```

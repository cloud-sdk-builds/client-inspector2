...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.82.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.82.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YrGQsVqz3hsI/jbeO2Sc9jsG4HBIY2Gbwri2+ik1qECK3m+kopLC4v3dfO6bZ2RW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.82.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.82.0/index.min.mjs": "sha384-YrGQsVqz3hsI/jbeO2Sc9jsG4HBIY2Gbwri2+ik1qECK3m+kopLC4v3dfO6bZ2RW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.82.0/LICENSE
```

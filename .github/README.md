...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.616.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.616.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pf01IjmH5UZKoTSe5mcUfsVN9z/NMtTbRz3B2hEZ1UvPV3y91+sbNdBJPtcHt2OO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.616.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.616.0/index.min.mjs": "sha384-pf01IjmH5UZKoTSe5mcUfsVN9z/NMtTbRz3B2hEZ1UvPV3y91+sbNdBJPtcHt2OO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.616.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.831.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.831.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d3jB9PZ4r+QIja8jCgIYMKCwmmOedeVMq/c8jhvcKsLyYsy9C9AapAr1se0aoMww
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.831.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.831.0/index.min.mjs": "sha384-d3jB9PZ4r+QIja8jCgIYMKCwmmOedeVMq/c8jhvcKsLyYsy9C9AapAr1se0aoMww"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.831.0/LICENSE
```

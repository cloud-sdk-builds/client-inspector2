...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.515.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.515.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XLUe4swkMe59Cv8fzfCPuYYGHZW2os+ULsN3KD89PY4DWjLEUVNbUPOY7PFToQ4j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.515.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.515.0/index.min.mjs": "sha384-XLUe4swkMe59Cv8fzfCPuYYGHZW2os+ULsN3KD89PY4DWjLEUVNbUPOY7PFToQ4j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.515.0/LICENSE
```

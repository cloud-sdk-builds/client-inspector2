...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.358.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.358.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-skNpnwhPC5iYvB8JLD9UragzVv0s9Zp9PaKyd7BTBb10KYOhSShWZeIyltmMSecD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.358.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.358.0/index.min.mjs": "sha384-skNpnwhPC5iYvB8JLD9UragzVv0s9Zp9PaKyd7BTBb10KYOhSShWZeIyltmMSecD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.358.0/LICENSE
```

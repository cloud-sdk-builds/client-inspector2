...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.1012.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1012.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZQTw0QMBSRQNUlgUZFEWb7TAWfqNowg9UUsxkoC9lpVio1Gnp8DAA+hLXqrnVm7b
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1012.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1012.0/index.min.mjs": "sha384-ZQTw0QMBSRQNUlgUZFEWb7TAWfqNowg9UUsxkoC9lpVio1Gnp8DAA+hLXqrnVm7b"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.1012.0/LICENSE
```

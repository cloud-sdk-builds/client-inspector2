...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.200.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.200.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-If+reD62Ynu0wIB9IjM0j15C9OoSVuJsKXCQyx0SUiYwmBONf2GLN0iyLCok1h+u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.200.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.200.0/index.min.mjs": "sha384-If+reD62Ynu0wIB9IjM0j15C9OoSVuJsKXCQyx0SUiYwmBONf2GLN0iyLCok1h+u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.200.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.887.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.887.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZtfvAf/0+nx5IG8WqWcF8UJB4SJr5+9TKMNkciL90K7xkSnAVtKxcIlV9os5oktv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.887.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.887.0/index.min.mjs": "sha384-ZtfvAf/0+nx5IG8WqWcF8UJB4SJr5+9TKMNkciL90K7xkSnAVtKxcIlV9os5oktv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.887.0/LICENSE
```

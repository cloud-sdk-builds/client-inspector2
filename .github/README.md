...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.473.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.473.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v9LO8BM7BNsA1HMRmGz+KgllPOcog0dd6BkZmmyVj23dik3Ki81DsTuZ2e0emKi3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.473.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.473.0/index.min.mjs": "sha384-v9LO8BM7BNsA1HMRmGz+KgllPOcog0dd6BkZmmyVj23dik3Ki81DsTuZ2e0emKi3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.473.0/LICENSE
```

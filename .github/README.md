...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.631.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.631.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-um+X2G3XLuDPjk4w5EjeM2mLeV/ckm+BPDlp/4ns0uLjLU46/QIHT/Lsz+jq76qc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.631.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.631.0/index.min.mjs": "sha384-um+X2G3XLuDPjk4w5EjeM2mLeV/ckm+BPDlp/4ns0uLjLU46/QIHT/Lsz+jq76qc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.631.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.682.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.682.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8K4u3r8aVzLcxhUnuxT3oJIxkZmOwiJ5HOm25p9TEL2LGZmen4xhEUsNBYCrpM7n
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.682.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.682.0/index.min.mjs": "sha384-8K4u3r8aVzLcxhUnuxT3oJIxkZmOwiJ5HOm25p9TEL2LGZmen4xhEUsNBYCrpM7n"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.682.0/LICENSE
```

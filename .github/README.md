...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.79.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.79.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8CBOzG0ssoMAiA/jnmjmcdiI8MmtEJ8TWpnup+acQqZfY1BhCM91rIHHUrhsNX+C
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.79.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.79.0/index.min.mjs": "sha384-8CBOzG0ssoMAiA/jnmjmcdiI8MmtEJ8TWpnup+acQqZfY1BhCM91rIHHUrhsNX+C"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.79.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.637.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.637.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Cke6az9RitDrvxZbz1KT4nRTKfRojp+i0kici7cn5Vl/FdPzFaEdGuKPHXM8tdaU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.637.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.637.0/index.min.mjs": "sha384-Cke6az9RitDrvxZbz1KT4nRTKfRojp+i0kici7cn5Vl/FdPzFaEdGuKPHXM8tdaU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.637.0/LICENSE
```

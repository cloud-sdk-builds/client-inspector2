...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.677.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.677.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yQ3uobPXB+XIcz0mi0xEIyKWbWJmQ3gAFQDFRocyGFzkJ8ZIOm+G8FJIvm58KTDb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.677.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.677.0/index.min.mjs": "sha384-yQ3uobPXB+XIcz0mi0xEIyKWbWJmQ3gAFQDFRocyGFzkJ8ZIOm+G8FJIvm58KTDb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.677.0/LICENSE
```

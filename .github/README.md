...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.504.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.504.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FiWnTpf3QTFeD9dyh8UEQ59CmLYled2PVAdU/yvmJ7peAd/bUiBQv8K40ijkrVjr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.504.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.504.0/index.min.mjs": "sha384-FiWnTpf3QTFeD9dyh8UEQ59CmLYled2PVAdU/yvmJ7peAd/bUiBQv8K40ijkrVjr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.504.0/LICENSE
```

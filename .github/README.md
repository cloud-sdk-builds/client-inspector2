...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.996.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.996.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Wta4JRNRF/oXGtYheSi5Bc973hdVDrU6gvskhjjR4tshLbYwtK4GXVYn9aOYZAEq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.996.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.996.0/index.min.mjs": "sha384-Wta4JRNRF/oXGtYheSi5Bc973hdVDrU6gvskhjjR4tshLbYwtK4GXVYn9aOYZAEq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.996.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.908.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.908.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FrZzM5EVFWSO0p/3q9t4qu2ONc1mWk5wgypwGszhmVE5VOMCrPywe4HK3Rqjvcq0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.908.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.908.0/index.min.mjs": "sha384-FrZzM5EVFWSO0p/3q9t4qu2ONc1mWk5wgypwGszhmVE5VOMCrPywe4HK3Rqjvcq0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.908.0/LICENSE
```

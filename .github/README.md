...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.163.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.163.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v1+3y79xhWkBMc2E6JXY0H+3ZlOGV5IgeimeztTcu64AxE4jqKYRGFZJ+8wfRVfq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.163.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.163.0/index.min.mjs": "sha384-v1+3y79xhWkBMc2E6JXY0H+3ZlOGV5IgeimeztTcu64AxE4jqKYRGFZJ+8wfRVfq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.163.0/LICENSE
```

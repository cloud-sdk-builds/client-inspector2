...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.121.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.121.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PqTxkEjvtZ2Ek7l1mnQ9wMXI/fljORm07KCt5jApHMc5lQoJj1a0vQmIWASdmwy6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.121.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.121.0/index.min.mjs": "sha384-PqTxkEjvtZ2Ek7l1mnQ9wMXI/fljORm07KCt5jApHMc5lQoJj1a0vQmIWASdmwy6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.121.0/LICENSE
```

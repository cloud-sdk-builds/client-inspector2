...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.193.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.193.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-j+LOcqy8OPRhnCJS2MKy4oDSsCXA8DgOVQQVoh7ZOcrpRzgxXrChrR+VwYx+nN7F
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.193.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.193.0/index.min.mjs": "sha384-j+LOcqy8OPRhnCJS2MKy4oDSsCXA8DgOVQQVoh7ZOcrpRzgxXrChrR+VwYx+nN7F"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.193.0/LICENSE
```

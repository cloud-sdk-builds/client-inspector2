...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.596.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.596.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XpB5q6xZorAm1+KU93lQ/JDrYQzKC/Bh9u2/IBAsrAFytGUexQN5qwKxulS0FODS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.596.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.596.0/index.min.mjs": "sha384-XpB5q6xZorAm1+KU93lQ/JDrYQzKC/Bh9u2/IBAsrAFytGUexQN5qwKxulS0FODS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.596.0/LICENSE
```

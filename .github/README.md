...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.984.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.984.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tUQp6QD0SbED+Y9dxjWQwMkfGEcsl1gZqLN9Z+32XdyIMd4whip7n0X/yNvi8CAi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.984.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.984.0/index.min.mjs": "sha384-tUQp6QD0SbED+Y9dxjWQwMkfGEcsl1gZqLN9Z+32XdyIMd4whip7n0X/yNvi8CAi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.984.0/LICENSE
```

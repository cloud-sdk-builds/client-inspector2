...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.141.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.141.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V1WlfaHh7pXOQuYQKcutEZ0nm1P84CmX1zukQt/mikAhfCY6T/Vh9EcOpWAQCP+9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.141.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.141.0/index.min.mjs": "sha384-V1WlfaHh7pXOQuYQKcutEZ0nm1P84CmX1zukQt/mikAhfCY6T/Vh9EcOpWAQCP+9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.141.0/LICENSE
```

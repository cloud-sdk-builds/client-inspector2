...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.408.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.408.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zDb3e36eWvl+PANCEu5bNSpXB3HYo7QNhYYNRMhg5FBwgJGhqy0KQZhMCkRTwLGW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.408.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.408.0/index.min.mjs": "sha384-zDb3e36eWvl+PANCEu5bNSpXB3HYo7QNhYYNRMhg5FBwgJGhqy0KQZhMCkRTwLGW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.408.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.490.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.490.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7uW2Q7p1IE+dcVUTNBwldnQ/T9kYsr74hyB0WvTtug07tB/gzsp9TutLrDd99BH8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.490.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.490.0/index.min.mjs": "sha384-7uW2Q7p1IE+dcVUTNBwldnQ/T9kYsr74hyB0WvTtug07tB/gzsp9TutLrDd99BH8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.490.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.54.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.54.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-oZn5NH6xJ7IKV1DXhkOXnQxeOwgoOXSXSgVpWrJtfQzniDT0Ak//cgDnF93AKhS5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.54.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.54.1/index.min.mjs": "sha384-oZn5NH6xJ7IKV1DXhkOXnQxeOwgoOXSXSgVpWrJtfQzniDT0Ak//cgDnF93AKhS5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.54.1/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.535.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.535.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I/wIRLApejlKY8aPZcP+uZSFMM6IMALa1yyBU/Fb939BQa8NtuKOpyaG2v+w0qBg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.535.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.535.0/index.min.mjs": "sha384-I/wIRLApejlKY8aPZcP+uZSFMM6IMALa1yyBU/Fb939BQa8NtuKOpyaG2v+w0qBg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.535.0/LICENSE
```

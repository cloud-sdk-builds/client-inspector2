...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.946.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.946.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1L8lglm0HCN2E7U7yCqs657RQecNM5EwgBi2T3erYyxwsZT4X4h4ZQcv5T0yd1jy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.946.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.946.0/index.min.mjs": "sha384-1L8lglm0HCN2E7U7yCqs657RQecNM5EwgBi2T3erYyxwsZT4X4h4ZQcv5T0yd1jy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.946.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.998.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.998.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-F+uuS7NrTvl5vQZttLu7zQfmQyNGPCtm5GCdSpUScQLobk4m0u1Bcc0b9RYPS++l
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.998.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.998.0/index.min.mjs": "sha384-F+uuS7NrTvl5vQZttLu7zQfmQyNGPCtm5GCdSpUScQLobk4m0u1Bcc0b9RYPS++l"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.998.0/LICENSE
```

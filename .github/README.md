...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.315.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.315.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y9HyiUXMh7hTVm0K2NkW8dh/ttiSg34GKxn0sl37kuW21vJcgsAw/QtHrurZ/b/x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.315.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.315.0/index.min.mjs": "sha384-y9HyiUXMh7hTVm0K2NkW8dh/ttiSg34GKxn0sl37kuW21vJcgsAw/QtHrurZ/b/x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.315.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.855.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.855.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PUcK3kPXG1nR3DUKjiGnOQB4M4+AdQfnRy7IssRs4wQb3rZcd+9ooaQyFeo+KcC3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.855.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.855.0/index.min.mjs": "sha384-PUcK3kPXG1nR3DUKjiGnOQB4M4+AdQfnRy7IssRs4wQb3rZcd+9ooaQyFeo+KcC3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.855.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.741.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.741.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LtCsgHIAX2lAT0mxfEqnCO8JMjm5Y5EEZtVQGU8H0UikBHTGLIJ2n6WEUNCo6+tm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.741.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.741.0/index.min.mjs": "sha384-LtCsgHIAX2lAT0mxfEqnCO8JMjm5Y5EEZtVQGU8H0UikBHTGLIJ2n6WEUNCo6+tm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.741.0/LICENSE
```

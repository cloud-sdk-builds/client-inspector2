...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.350.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.350.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0XkmOK875rDRag8gLNi1R+Y+wVBqMYYTxQJYe6woKpR3u3mqgzOIZch4bFgLzBNj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.350.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.350.0/index.min.mjs": "sha384-0XkmOK875rDRag8gLNi1R+Y+wVBqMYYTxQJYe6woKpR3u3mqgzOIZch4bFgLzBNj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.350.0/LICENSE
```

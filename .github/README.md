...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.592.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.592.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dwW/FFYyR6+LhAzkaYAVLEM7BLDr8cZuok/yaBei2hs6ytfa9nVYYXhGqVt32h5r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.592.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.592.0/index.min.mjs": "sha384-dwW/FFYyR6+LhAzkaYAVLEM7BLDr8cZuok/yaBei2hs6ytfa9nVYYXhGqVt32h5r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.592.0/LICENSE
```

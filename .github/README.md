...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.254.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.254.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-o2oaHbaR+5PmWKfj2fCqhZ0VQ0Ri/SEkJp6Pq6qaaQd/F9oMP6ngpRLDbRiCSLII
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.254.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.254.0/index.min.mjs": "sha384-o2oaHbaR+5PmWKfj2fCqhZ0VQ0Ri/SEkJp6Pq6qaaQd/F9oMP6ngpRLDbRiCSLII"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.254.0/LICENSE
```

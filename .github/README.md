...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.72.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.72.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5ExtGqsuxpPNuGLRh6e6luFs3DRNl3mJZEivH0wUlLw3uJTIDSsGKFVAbDE/EaLh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.72.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.72.0/index.min.mjs": "sha384-5ExtGqsuxpPNuGLRh6e6luFs3DRNl3mJZEivH0wUlLw3uJTIDSsGKFVAbDE/EaLh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.72.0/LICENSE
```

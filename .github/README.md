...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.953.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.953.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3FH2nKSOa0jAXF/yqhic8HpCmdZZTtvmGKbLb2bCdUYFhBnhoqk7yjRXsTHy/5iK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.953.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.953.0/index.min.mjs": "sha384-3FH2nKSOa0jAXF/yqhic8HpCmdZZTtvmGKbLb2bCdUYFhBnhoqk7yjRXsTHy/5iK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.953.0/LICENSE
```

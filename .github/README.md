...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.521.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.521.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O3dttiw4caEXVZayWO9SGOfJGoMF7EDNPoXdHEFSAP2IkgarD0ekaRs7UjZRzN86
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.521.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.521.0/index.min.mjs": "sha384-O3dttiw4caEXVZayWO9SGOfJGoMF7EDNPoXdHEFSAP2IkgarD0ekaRs7UjZRzN86"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.521.0/LICENSE
```

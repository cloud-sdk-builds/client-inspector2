...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.939.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.939.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Vlverlkvuv2TRADd7AOp+vFAcDoHmr0KTHL8++c62XwfBb8UJPhAzhd7vC4QvLWJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.939.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.939.0/index.min.mjs": "sha384-Vlverlkvuv2TRADd7AOp+vFAcDoHmr0KTHL8++c62XwfBb8UJPhAzhd7vC4QvLWJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.939.0/LICENSE
```

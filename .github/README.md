...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.873.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.873.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WRpoQtCHmeK4FkMH+USTpRMqN0Cmt8L5txODefBVrutu5KBke6zeO7cd2bGBgM6p
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.873.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.873.0/index.min.mjs": "sha384-WRpoQtCHmeK4FkMH+USTpRMqN0Cmt8L5txODefBVrutu5KBke6zeO7cd2bGBgM6p"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.873.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.731.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.731.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1Nu5GKmmzGvKOTOEXVQ4C6uR8PAbD9j2raqViyHZBmfzg5jhrXlCWaDj/psPNLzu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.731.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.731.0/index.min.mjs": "sha384-1Nu5GKmmzGvKOTOEXVQ4C6uR8PAbD9j2raqViyHZBmfzg5jhrXlCWaDj/psPNLzu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.731.0/LICENSE
```

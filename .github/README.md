...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.219.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.219.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-krHTQ2ZAEms8dExyc1VetRcdz+RNbg/VB5ets2EK21IEbtsNhfKcPZflTJU5GrEI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.219.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.219.0/index.min.mjs": "sha384-krHTQ2ZAEms8dExyc1VetRcdz+RNbg/VB5ets2EK21IEbtsNhfKcPZflTJU5GrEI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.219.0/LICENSE
```

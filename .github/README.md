...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.511.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.511.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3lgmuiI8MUA1C/9ftiEsfmVSYTA6P3q7o3MTGZJzQi89ORGkzzxTKNJjlq8q5bvo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.511.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.511.0/index.min.mjs": "sha384-3lgmuiI8MUA1C/9ftiEsfmVSYTA6P3q7o3MTGZJzQi89ORGkzzxTKNJjlq8q5bvo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.511.0/LICENSE
```

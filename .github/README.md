...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.588.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.588.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fcYKH9Kcd09kH8XfpmbEJqEq6d1qNJw8XElniK+CSFnukFrnLemaHThEhjJQqSHS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.588.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.588.0/index.min.mjs": "sha384-fcYKH9Kcd09kH8XfpmbEJqEq6d1qNJw8XElniK+CSFnukFrnLemaHThEhjJQqSHS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.588.0/LICENSE
```

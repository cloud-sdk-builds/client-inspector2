...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.969.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.969.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ku6dNtNUwjE6u2tkF3lVrnOeYAs5UDEFDHXvrZPdETdYBkROk1vzs2/jt+J6Nefy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.969.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.969.0/index.min.mjs": "sha384-Ku6dNtNUwjE6u2tkF3lVrnOeYAs5UDEFDHXvrZPdETdYBkROk1vzs2/jt+J6Nefy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.969.0/LICENSE
```

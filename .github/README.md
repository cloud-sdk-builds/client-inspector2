...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.714.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.714.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bzKqF8G27aaccKfH6g2QNYwroWL8ftCexNd2t/cEBYDE+/cyFSWjKqheEE4KS4hB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.714.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.714.0/index.min.mjs": "sha384-bzKqF8G27aaccKfH6g2QNYwroWL8ftCexNd2t/cEBYDE+/cyFSWjKqheEE4KS4hB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.714.0/LICENSE
```

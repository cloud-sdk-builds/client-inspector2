...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.968.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.968.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-apaLMr0gJDM81+d9fiOxH4g8DvsQzLzO33NRxHOtQdQJvfrGL7ynYSDL2dNVBPNa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.968.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.968.0/index.min.mjs": "sha384-apaLMr0gJDM81+d9fiOxH4g8DvsQzLzO33NRxHOtQdQJvfrGL7ynYSDL2dNVBPNa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.968.0/LICENSE
```

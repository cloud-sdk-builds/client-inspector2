...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.266.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.266.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-p7uZ0YIU+wDLB4kY/bOiwYbEc5Mbqu12U/ivaXdUTpnRtKL3/e5xTGihI+OIizyR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.266.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.266.1/index.min.mjs": "sha384-p7uZ0YIU+wDLB4kY/bOiwYbEc5Mbqu12U/ivaXdUTpnRtKL3/e5xTGihI+OIizyR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.266.1/LICENSE
```

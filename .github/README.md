...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.1023.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1023.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7DMDhNUizqqhjKQ2ajTF1A7UN+4DIYwUVuIiaDk8a9E6vuHw0M2vjLMC+C+ZZno5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1023.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1023.0/index.min.mjs": "sha384-7DMDhNUizqqhjKQ2ajTF1A7UN+4DIYwUVuIiaDk8a9E6vuHw0M2vjLMC+C+ZZno5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.1023.0/LICENSE
```

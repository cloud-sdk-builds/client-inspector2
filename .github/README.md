...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.859.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.859.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SCONwhVdBjjNf//7Xn/MNl5r+lD5pFelogjMk0+wJJPg0ftDp4hcE2+QGclL6lNm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.859.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.859.0/index.min.mjs": "sha384-SCONwhVdBjjNf//7Xn/MNl5r+lD5pFelogjMk0+wJJPg0ftDp4hcE2+QGclL6lNm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.859.0/LICENSE
```

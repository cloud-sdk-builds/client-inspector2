...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.620.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.620.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IEHeoTP/LFHITBDvpdJ/qboH2w9LoehxeN334sOcAZzx+ioI2xVsqABBNnSQjqKr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.620.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.620.0/index.min.mjs": "sha384-IEHeoTP/LFHITBDvpdJ/qboH2w9LoehxeN334sOcAZzx+ioI2xVsqABBNnSQjqKr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.620.0/LICENSE
```

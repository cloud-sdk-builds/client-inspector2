...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.118.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.118.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-w2AJmE4ITEKP/LQapk2EHmJhUEV4maIYn2JkEhZ+wO/puPu1ir8tdUcXYqdpE1nx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.118.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.118.0/index.min.mjs": "sha384-w2AJmE4ITEKP/LQapk2EHmJhUEV4maIYn2JkEhZ+wO/puPu1ir8tdUcXYqdpE1nx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.118.0/LICENSE
```

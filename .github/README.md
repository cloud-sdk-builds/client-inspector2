...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.577.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.577.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3aYEL8V6Ft87itUMZ3JfB+8D82nimqHBs5Jvj0jk1/EidsJ+LPShZiWgpzfA18Op
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.577.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.577.0/index.min.mjs": "sha384-3aYEL8V6Ft87itUMZ3JfB+8D82nimqHBs5Jvj0jk1/EidsJ+LPShZiWgpzfA18Op"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.577.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.78.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.78.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7Ab5tCDartsleJD2KIt98bfLdz/8OMge4ZAzk440XkcP7BxPSBeCg5GwitIBZPSA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.78.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.78.0/index.min.mjs": "sha384-7Ab5tCDartsleJD2KIt98bfLdz/8OMge4ZAzk440XkcP7BxPSBeCg5GwitIBZPSA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.78.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.234.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.234.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7eUpNQWQU3NN1H0T2UntLmM4bVfS19ufbJLG6Kcx0qFii9PT9ZqXSyzLCuXGDv9/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.234.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.234.0/index.min.mjs": "sha384-7eUpNQWQU3NN1H0T2UntLmM4bVfS19ufbJLG6Kcx0qFii9PT9ZqXSyzLCuXGDv9/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.234.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.507.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.507.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C/sIK8wBagpxNpomFhGE5RRDWuSQ50gL5RSxh2nZojN2qqnr1CS2Zoc7dsi/RVdb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.507.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.507.0/index.min.mjs": "sha384-C/sIK8wBagpxNpomFhGE5RRDWuSQ50gL5RSxh2nZojN2qqnr1CS2Zoc7dsi/RVdb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.507.0/LICENSE
```

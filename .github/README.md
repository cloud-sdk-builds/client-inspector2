...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.823.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.823.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OiUssu8ZUGtWOFJpnmij/c/9K2/KaKvNHmjetj125dSFbZzVCNYbWk2Lp6/gKq5v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.823.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.823.0/index.min.mjs": "sha384-OiUssu8ZUGtWOFJpnmij/c/9K2/KaKvNHmjetj125dSFbZzVCNYbWk2Lp6/gKq5v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.823.0/LICENSE
```

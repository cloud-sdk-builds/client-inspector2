...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.496.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.496.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tsPnWaIW3d13YDsCjJYJ48q7ENMds/lF+poXMUtlrZfJU2LkqcUXwGa3VhR8BstX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.496.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.496.0/index.min.mjs": "sha384-tsPnWaIW3d13YDsCjJYJ48q7ENMds/lF+poXMUtlrZfJU2LkqcUXwGa3VhR8BstX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.496.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.94.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.94.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ffsXll7DEDy8SU8Onl0mYjpXGPKV2wpE9ieJWCO+1H3DH5uPYiO/lU0Lxm0kLiU3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.94.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.94.0/index.min.mjs": "sha384-ffsXll7DEDy8SU8Onl0mYjpXGPKV2wpE9ieJWCO+1H3DH5uPYiO/lU0Lxm0kLiU3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.94.0/LICENSE
```

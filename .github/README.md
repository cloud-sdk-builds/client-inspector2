...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.470.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.470.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Zst4zWuCpEW0AoobIGEAaRg6h2lvh/Zdlhxm5XAoM5kwpx+AmlHaBRZPPYMNtFO6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.470.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.470.0/index.min.mjs": "sha384-Zst4zWuCpEW0AoobIGEAaRg6h2lvh/Zdlhxm5XAoM5kwpx+AmlHaBRZPPYMNtFO6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.470.0/LICENSE
```

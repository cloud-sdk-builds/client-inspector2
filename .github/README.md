...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.806.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.806.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UI0mAqUXb4oEXf6qUEndDTCjBqSLPFiJJwv6d9IAdPOnvFln3i5mIFXirZOk1tbY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.806.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.806.0/index.min.mjs": "sha384-UI0mAqUXb4oEXf6qUEndDTCjBqSLPFiJJwv6d9IAdPOnvFln3i5mIFXirZOk1tbY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.806.0/LICENSE
```

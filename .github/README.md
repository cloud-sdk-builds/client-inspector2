...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.502.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.502.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DibWDxO4dy08Trsr80nzAAVNPOnl5ExWR5+Sa0EkHmceYjQWbOJ27BYcUPvcDkmo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.502.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.502.0/index.min.mjs": "sha384-DibWDxO4dy08Trsr80nzAAVNPOnl5ExWR5+Sa0EkHmceYjQWbOJ27BYcUPvcDkmo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.502.0/LICENSE
```

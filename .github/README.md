...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.879.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.879.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yIdFwY37yY00XlNIZKgohmnsa5xICrGCvvfnqopB5F+3TwOlECsg0FQTY7iYV1fQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.879.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.879.0/index.min.mjs": "sha384-yIdFwY37yY00XlNIZKgohmnsa5xICrGCvvfnqopB5F+3TwOlECsg0FQTY7iYV1fQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.879.0/LICENSE
```

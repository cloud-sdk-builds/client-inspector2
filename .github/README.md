...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.329.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.329.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NRaWocOC0L+C0gQjN9qRjtEnThN6+TkHU1Yvsk/W48gtX87cENFFQbMPVnIO0v8d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.329.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.329.0/index.min.mjs": "sha384-NRaWocOC0L+C0gQjN9qRjtEnThN6+TkHU1Yvsk/W48gtX87cENFFQbMPVnIO0v8d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.329.0/LICENSE
```

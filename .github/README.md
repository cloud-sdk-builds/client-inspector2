...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.621.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.621.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lb9ApaKc7kU5sNt8JfLbYD+puIneFQnO0r676PpfYCzR53db6amVVLKpMfK0oIfW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.621.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.621.0/index.min.mjs": "sha384-lb9ApaKc7kU5sNt8JfLbYD+puIneFQnO0r676PpfYCzR53db6amVVLKpMfK0oIfW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.621.0/LICENSE
```

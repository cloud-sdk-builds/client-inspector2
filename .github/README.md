...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.231.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.231.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YRlmiyw7wTgaXYWKSneWWTaUA5rpwSM1WjH9lL+k6oZ7lCMFy3cg4HUCnXgCmvOk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.231.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.231.0/index.min.mjs": "sha384-YRlmiyw7wTgaXYWKSneWWTaUA5rpwSM1WjH9lL+k6oZ7lCMFy3cg4HUCnXgCmvOk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.231.0/LICENSE
```

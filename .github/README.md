...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.201.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.201.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FvNA3dGPeU56OXGKOYBzGEphh1sgh/6cLMWviT4TYE8vhC6roQsuo/wCSfxmt9aU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.201.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.201.0/index.min.mjs": "sha384-FvNA3dGPeU56OXGKOYBzGEphh1sgh/6cLMWviT4TYE8vhC6roQsuo/wCSfxmt9aU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.201.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.460.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.460.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MN1iPM2KuJQVfKEpJys+DQ2sjICE2/qBdBv2p+eusDaRRVqVwbyzTPeC+JgwY82D
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.460.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.460.0/index.min.mjs": "sha384-MN1iPM2KuJQVfKEpJys+DQ2sjICE2/qBdBv2p+eusDaRRVqVwbyzTPeC+JgwY82D"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.460.0/LICENSE
```

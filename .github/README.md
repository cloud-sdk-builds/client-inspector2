...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.862.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.862.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gvp+BQmN7OvW5ClnZ6cKZq1yX4RjS6rTWMySXLjNLhTEY7q0Hb8pSrusQcOFGiRh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.862.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.862.0/index.min.mjs": "sha384-gvp+BQmN7OvW5ClnZ6cKZq1yX4RjS6rTWMySXLjNLhTEY7q0Hb8pSrusQcOFGiRh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.862.0/LICENSE
```

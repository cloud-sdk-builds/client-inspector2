...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.169.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.169.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bavM7sTr1ZG4C5V48ysVMfL8xYSuogwy4e/SGNUw+v7GZX2t1kGNjG/v2uMq1+p1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.169.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.169.0/index.min.mjs": "sha384-bavM7sTr1ZG4C5V48ysVMfL8xYSuogwy4e/SGNUw+v7GZX2t1kGNjG/v2uMq1+p1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.169.0/LICENSE
```

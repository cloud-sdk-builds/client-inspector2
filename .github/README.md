...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.808.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.808.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4/vdkg7tpOfGIYduhs5ffqktCJn6zP/hSPiP8ZpVXwndqz79IVHLJz6CRBqj14Ap
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.808.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.808.0/index.min.mjs": "sha384-4/vdkg7tpOfGIYduhs5ffqktCJn6zP/hSPiP8ZpVXwndqz79IVHLJz6CRBqj14Ap"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.808.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.957.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.957.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cMrmLi2iBVuLBGR/hbmJhkNVuHByz14TuglKTG+AGXBR4cDulgAdU8NLv8Y5EhUK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.957.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.957.0/index.min.mjs": "sha384-cMrmLi2iBVuLBGR/hbmJhkNVuHByz14TuglKTG+AGXBR4cDulgAdU8NLv8Y5EhUK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.957.0/LICENSE
```

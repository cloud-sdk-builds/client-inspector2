...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.738.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.738.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VIKfPfU+C+HSjC/Db/z4d/zNTuspMM4k8L9Q1EARsK/XfI5pM/2RhlWwQ1dp+hKh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.738.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.738.0/index.min.mjs": "sha384-VIKfPfU+C+HSjC/Db/z4d/zNTuspMM4k8L9Q1EARsK/XfI5pM/2RhlWwQ1dp+hKh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.738.0/LICENSE
```

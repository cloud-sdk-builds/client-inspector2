...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.75.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.75.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uBlSvoqx0XSNbddenGz9Da3RBU4WTpGaLogLKC7krMuAdj2e4hzoHpNbT5z9Lhet
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.75.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.75.0/index.min.mjs": "sha384-uBlSvoqx0XSNbddenGz9Da3RBU4WTpGaLogLKC7krMuAdj2e4hzoHpNbT5z9Lhet"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.75.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.154.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.154.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rY8dBEcBecX+oevl+0kEaBXWTtfLNnjbcDQBPic9KCYV5qocgp5HdRx1sgwJultK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.154.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.154.0/index.min.mjs": "sha384-rY8dBEcBecX+oevl+0kEaBXWTtfLNnjbcDQBPic9KCYV5qocgp5HdRx1sgwJultK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.154.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.347.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.347.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+MOCjqEhAeR4wHf4f08F3bMA4bT6Hx7VmZh7ybNiT5jQu5LUUGDJSX+gDSKkIgKd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.347.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.347.0/index.min.mjs": "sha384-+MOCjqEhAeR4wHf4f08F3bMA4bT6Hx7VmZh7ybNiT5jQu5LUUGDJSX+gDSKkIgKd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.347.0/LICENSE
```

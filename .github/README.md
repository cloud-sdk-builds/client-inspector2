...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.118.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.118.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-7yQXgZOa65ufov6ZC/74pICUB5vBmkWFmk9YWA5oCzzTjzy2EFnqquzcFiYBDAim
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.118.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.118.1/index.min.mjs": "sha384-7yQXgZOa65ufov6ZC/74pICUB5vBmkWFmk9YWA5oCzzTjzy2EFnqquzcFiYBDAim"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.118.1/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.209.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.209.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1z6C6PYANqk0Ajh+PM4jfr8Kp2tCaQqM6aecveJLFjYyk23GbZ5b8CvJY3JDSFNw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.209.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.209.0/index.min.mjs": "sha384-1z6C6PYANqk0Ajh+PM4jfr8Kp2tCaQqM6aecveJLFjYyk23GbZ5b8CvJY3JDSFNw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.209.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.772.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.772.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Crz7YiTJvra10rv8rrmraYq9lOm3FwFLWv+fMBVnrDtqgMOM8lQ9GiFkvKfH9JDV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.772.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.772.0/index.min.mjs": "sha384-Crz7YiTJvra10rv8rrmraYq9lOm3FwFLWv+fMBVnrDtqgMOM8lQ9GiFkvKfH9JDV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.772.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.267.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.267.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OZLbj6tXc4JAb2k/SGAJI87lQrgBGbVhackx2nIQ/4Vw3PWpP+N4B7T6ON1gaMwb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.267.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.267.0/index.min.mjs": "sha384-OZLbj6tXc4JAb2k/SGAJI87lQrgBGbVhackx2nIQ/4Vw3PWpP+N4B7T6ON1gaMwb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.267.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.920.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.920.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z4Wru/48XrSapPQCbT5dslwqyGGd4ZKup0gNPyOqr/h5IgtaN94wA+ctNTXjlWuM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.920.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.920.0/index.min.mjs": "sha384-Z4Wru/48XrSapPQCbT5dslwqyGGd4ZKup0gNPyOqr/h5IgtaN94wA+ctNTXjlWuM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.920.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.613.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.613.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6rc2m8uQFndXY3gPPLGiqZchS2fIcloBd+ck99R1lajRT4vBvAe+i050LSjPqUdK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.613.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.613.0/index.min.mjs": "sha384-6rc2m8uQFndXY3gPPLGiqZchS2fIcloBd+ck99R1lajRT4vBvAe+i050LSjPqUdK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.613.0/LICENSE
```

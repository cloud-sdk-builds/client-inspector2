...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.567.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.567.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/CTwZWeYuX2TpeLkv9Gwf5nUoL+z7plCpz9de9/g0abMypFAqDQf6q8/9jg/kiLu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.567.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.567.0/index.min.mjs": "sha384-/CTwZWeYuX2TpeLkv9Gwf5nUoL+z7plCpz9de9/g0abMypFAqDQf6q8/9jg/kiLu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.567.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.981.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.981.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eWfRoGY3TWKCrNb/l9U5FhizZs5XXkd4eOjBI0QZp+PC/7nO91/UfGng7fBCU9fo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.981.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.981.0/index.min.mjs": "sha384-eWfRoGY3TWKCrNb/l9U5FhizZs5XXkd4eOjBI0QZp+PC/7nO91/UfGng7fBCU9fo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.981.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.405.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.405.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vlqXkSGm1Bard9ANyGhJ8rAfQ3l7OywwX+Jltks6CtjJfVz4/KQ5AyyHPso31Ae9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.405.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.405.0/index.min.mjs": "sha384-vlqXkSGm1Bard9ANyGhJ8rAfQ3l7OywwX+Jltks6CtjJfVz4/KQ5AyyHPso31Ae9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.405.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.378.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.378.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+GUubHnzwDYpQxqhahu7z4woXhv++zR1t3V2azFQCNG2lkcTZDgc3vX1L+hqhGAQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.378.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.378.0/index.min.mjs": "sha384-+GUubHnzwDYpQxqhahu7z4woXhv++zR1t3V2azFQCNG2lkcTZDgc3vX1L+hqhGAQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.378.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.261.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.261.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-n8UpL5/PDVwHvCPAi2P41lvL+VMyrpB0LIvYVuZd6TZGKGGUvMm+dY807a5KYymi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.261.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.261.0/index.min.mjs": "sha384-n8UpL5/PDVwHvCPAi2P41lvL+VMyrpB0LIvYVuZd6TZGKGGUvMm+dY807a5KYymi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.261.0/LICENSE
```

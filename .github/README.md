...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.137.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.137.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z98LbLoU6L6/+qdkCawExIFjRCrC+soHcikqbpPI/YJI3+13b3fWJmcUWISBsMGV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.137.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.137.0/index.min.mjs": "sha384-Z98LbLoU6L6/+qdkCawExIFjRCrC+soHcikqbpPI/YJI3+13b3fWJmcUWISBsMGV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.137.0/LICENSE
```

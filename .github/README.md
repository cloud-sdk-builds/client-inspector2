...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.1005.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1005.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VfR+7keIh/gyARuICYTsVy6orfMGqPHezluL+Vs3Hi3IkI0yLNh3vRCmTtv6nlKm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1005.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.1005.0/index.min.mjs": "sha384-VfR+7keIh/gyARuICYTsVy6orfMGqPHezluL+Vs3Hi3IkI0yLNh3vRCmTtv6nlKm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.1005.0/LICENSE
```

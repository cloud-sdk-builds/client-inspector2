...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.600.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.600.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CTBYQkIYww8G1qLy8QIwFCxDCnQ1bKNcyxpXHGHiuAP03a1ZWMRgCAu+hqedXszv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.600.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.600.0/index.min.mjs": "sha384-CTBYQkIYww8G1qLy8QIwFCxDCnQ1bKNcyxpXHGHiuAP03a1ZWMRgCAu+hqedXszv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.600.0/LICENSE
```

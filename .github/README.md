...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.325.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.325.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9vTOdVf3VrJej8wSadrtf3O3ENE+MOTK4pCd6vfvo0O1aEHIZEAK1Pw/4QNbY9+0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.325.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.325.0/index.min.mjs": "sha384-9vTOdVf3VrJej8wSadrtf3O3ENE+MOTK4pCd6vfvo0O1aEHIZEAK1Pw/4QNbY9+0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.325.0/LICENSE
```

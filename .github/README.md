...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.848.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.848.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-khUrNbZ4P6bJUB4Xvjn0RjXGBmF+aykrf5CnZYpMeK6xJqf4lhTHLWG5w9jNQZj6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.848.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.848.0/index.min.mjs": "sha384-khUrNbZ4P6bJUB4Xvjn0RjXGBmF+aykrf5CnZYpMeK6xJqf4lhTHLWG5w9jNQZj6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.848.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.425.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.425.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-B7vboOqx+8G/nM7FlxoLkFB/1CKZND3AQIIvPSQvfGMA4+vtVmqtG1qFa89/zXQK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.425.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.425.0/index.min.mjs": "sha384-B7vboOqx+8G/nM7FlxoLkFB/1CKZND3AQIIvPSQvfGMA4+vtVmqtG1qFa89/zXQK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.425.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.513.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.513.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eG7iuwBzb66AVzoPXEqNHnHfGb9aahzMPZGXb4GTZEXT38Rcrtnj5fQgTU5bwAWW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.513.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.513.0/index.min.mjs": "sha384-eG7iuwBzb66AVzoPXEqNHnHfGb9aahzMPZGXb4GTZEXT38Rcrtnj5fQgTU5bwAWW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.513.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.509.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.509.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z9o1OKMZDlsh6XOV9sF+ZRa7QNuWW5HodLCLIaq4jHNnChIvI1SxSCJ6cIiumztF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.509.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.509.0/index.min.mjs": "sha384-Z9o1OKMZDlsh6XOV9sF+ZRa7QNuWW5HodLCLIaq4jHNnChIvI1SxSCJ6cIiumztF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.509.0/LICENSE
```

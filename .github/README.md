...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.335.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.335.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1m5/ZCw7P17AZliTz0Pqi2oPJ+z7TCMjlWiSNA6yuLef06zc0zkIFtZPzd+TKmPC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.335.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.335.0/index.min.mjs": "sha384-1m5/ZCw7P17AZliTz0Pqi2oPJ+z7TCMjlWiSNA6yuLef06zc0zkIFtZPzd+TKmPC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.335.0/LICENSE
```

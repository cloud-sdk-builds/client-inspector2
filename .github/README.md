...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.319.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.319.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ecFTxo8eOW1xVwqblqcA3zlm8mlg7OLm8GvRUdotdtQSHUBqoMW2C2OqJRWsj73u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.319.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.319.0/index.min.mjs": "sha384-ecFTxo8eOW1xVwqblqcA3zlm8mlg7OLm8GvRUdotdtQSHUBqoMW2C2OqJRWsj73u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.319.0/LICENSE
```

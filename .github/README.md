...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.192.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.192.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0sIDfhz84CJ7oPB0mo8RwD7yzJgY+qiS8TKW/l2L6EbYTZgKyCloGF1LwjvL+8gk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.192.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.192.0/index.min.mjs": "sha384-0sIDfhz84CJ7oPB0mo8RwD7yzJgY+qiS8TKW/l2L6EbYTZgKyCloGF1LwjvL+8gk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.192.0/LICENSE
```

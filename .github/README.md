...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.804.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.804.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dqX/0GfR4gIeWebTpDQZJxTPJR/0k7XejkCLZl93H4C4msJKWuRLpLjo6gvkpkUt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.804.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.804.0/index.min.mjs": "sha384-dqX/0GfR4gIeWebTpDQZJxTPJR/0k7XejkCLZl93H4C4msJKWuRLpLjo6gvkpkUt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.804.0/LICENSE
```

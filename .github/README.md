...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.395.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.395.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1yv2WDVEtqJ4VkeTZI6fvMj4HDLNDypkCHAHbCmAjF4PuA2G8QlbtNbeClIg/eFS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.395.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.395.0/index.min.mjs": "sha384-1yv2WDVEtqJ4VkeTZI6fvMj4HDLNDypkCHAHbCmAjF4PuA2G8QlbtNbeClIg/eFS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.395.0/LICENSE
```

...
[`@aws-sdk/client-inspector2`](https://www.npmjs.com/package/@aws-sdk/client-inspector2/v/3.812.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.812.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1iHwCYajUamQvz1lpQEnBBc2YbPULejI8Jsz8sqOH7MSO0lmZIvmiZ2ZVZ9OqtMt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-inspector2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.812.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-inspector2@3.812.0/index.min.mjs": "sha384-1iHwCYajUamQvz1lpQEnBBc2YbPULejI8Jsz8sqOH7MSO0lmZIvmiZ2ZVZ9OqtMt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-inspector2/blob/refs/tags/3.812.0/LICENSE
```
